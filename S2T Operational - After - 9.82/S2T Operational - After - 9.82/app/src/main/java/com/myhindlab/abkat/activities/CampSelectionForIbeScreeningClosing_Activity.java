...
public class CampSelectionForIbeScreeningClosing_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camp_selection_for_ibe_screening_closing);
    ...
    private void setDefaults() {
        context = CampSelectionForIbeScreeningClosing_Activity.this;
    ...
    private void setEventHandler() {
        ...
        recyclerview_campList.addOnItemTouchListener(
                new RecyclerItemClickListener(context, (view, position) -> {
                    ...
                    if (campDetails.getFLAG().equals("1")) {
                        ...
                        startActivity(new Intent(context, CloseBreastScreeningCamp.class)
                                .putExtra("selectedCamp", campDetails)
                                .putExtra("breastScreeningDeviceId", "0")
                                .putExtra("breastScreeningDeviceName", ""));
                    }
                }));
