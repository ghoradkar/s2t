...
public class DashboardPatientApp extends AppCompatActivity {
    PatientAppDashboardBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = PatientAppDashboardBinding.inflate(getLayoutInflater());
    ...
    void init() {
        mContext = DashboardPatientApp.this;
...
//        getAndroidIosCount();
    ...
    private void eventListener() {
        ...
        binding.cvTotal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(mContext, FibroScanningCountActivity.class));
            }
        });
...
//        });
    ...
    private void setUpToolbar() {
        ...
        getSupportActionBar().setTitle("Liver Scanning");
...
//        });
    ...
    private void getCount() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(DashboardPatientApp.this);
