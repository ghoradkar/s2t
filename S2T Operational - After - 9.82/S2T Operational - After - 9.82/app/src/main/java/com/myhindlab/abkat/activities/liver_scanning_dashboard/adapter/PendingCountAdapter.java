...
public class PendingCountAdapter extends RecyclerView.Adapter<PendingCountAdapter.myview> {
    List<PendingCountModel.Output> countList;
    Context context;


    public PendingCountAdapter(Context context, List<PendingCountModel.Output> countList ) {
...
//        holder.tv_SrName.setText(String.valueOf(position + 1));
        ...
        holder.tv_lab_type.setText(""+item.getHomeLabProcessingDelayed());
