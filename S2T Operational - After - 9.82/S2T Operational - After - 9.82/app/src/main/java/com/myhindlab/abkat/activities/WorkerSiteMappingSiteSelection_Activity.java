...
public class WorkerSiteMappingSiteSelection_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workersite_mappingsite_selection);
    ...
    private void setDefaults() {
        context = WorkerSiteMappingSiteSelection_Activity.this;
                ...
                new RecyclerItemClickListener(context,
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, final int position) {
                                ...
                                startActivity(new Intent(context, WorkerSiteMapping_Activity.class)
