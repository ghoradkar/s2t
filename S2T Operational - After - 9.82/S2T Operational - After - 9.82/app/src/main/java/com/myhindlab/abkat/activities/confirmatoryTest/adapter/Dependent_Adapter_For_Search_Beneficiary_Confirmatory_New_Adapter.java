...
import com.myhindlab.abkat.activities.confirmatoryTest.HealthScreeningSamplecollectionConfirmatoryEmergencyActivity;
...
public class Dependent_Adapter_For_Search_Beneficiary_Confirmatory_New_Adapter extends RecyclerView.Adapter<Dependent_Adapter_For_Search_Beneficiary_Confirmatory_New_Adapter.MyViewHolder>{
    ...
    public Dependent_Adapter_For_Search_Beneficiary_Confirmatory_New_Adapter(Context context, List<DependentForSearchBeneficiaryModel> resultArrayList, DepedentDetailsConfimatory eventListener,String distLgDCode) {
        ...
        holder.tv_patientname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (BuildConfig.isBeta){
                    context.startActivity(new Intent(context, HealthScreeningSamplecollectionConfirmatoryEmergencyActivity.class)
                            .putExtra("regdId", patientDetails.getRegdid())
                            .putExtra("regNo",patientDetails.getRegdNo())
                            .putExtra("t2tOrderId",patientDetails.getT2t_Order_Id())
                            ...
                            .putExtra("DISTLGDCODE", distLgDCode)
                    );
