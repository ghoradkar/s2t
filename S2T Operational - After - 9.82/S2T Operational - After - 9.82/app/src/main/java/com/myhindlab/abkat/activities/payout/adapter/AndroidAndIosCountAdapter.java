...
public class AndroidAndIosCountAdapter extends RecyclerView.Adapter<AndroidAndIosCountAdapter.CountViewHolder> {
    private final List<AndroidMobileCountModel.Count> countList;
    private final Context context;

    public AndroidAndIosCountAdapter(Context context, List<AndroidMobileCountModel.Count> countList) {
    ...
    public void onBindViewHolder(@NonNull CountViewHolder holder, int position) {
        ...
        holder.tv_count.setText(" " + item.getAndroid());
