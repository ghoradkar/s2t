...
public class UnregisteredWorkerSiteSelection_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unregisteredworker_siteselection);
    ...
    private void setDefaults() {
        context = UnregisteredWorkerSiteSelection_Activity.this;
                ...
                new RecyclerItemClickListener(context,
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, final int position) {
                                ...
                                startActivity(new Intent(context, UnregisteredWorkerReg_Activity.class)
