...
public class TeamsDetailsAssignedReportDeliveryAdapter extends RecyclerView.Adapter<TeamsDetailsAssignedReportDeliveryAdapter.MyViewHolder> {

    private final ArrayList<TeamsDetailsModel.OutputBean> teamList;

    public TeamsDetailsAssignedReportDeliveryAdapter(ArrayList<TeamsDetailsModel.OutputBean> teamList) {
