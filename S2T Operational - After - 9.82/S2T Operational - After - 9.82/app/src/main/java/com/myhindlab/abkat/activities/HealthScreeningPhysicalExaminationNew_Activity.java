...
import info.safey.graph.formatter.IFillFormatter;
import okhttp3.ResponseBody;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class HealthScreeningPhysicalExaminationNew_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private RadioGroup rbAsthma, rbSurgical, rbCurrentSymptoms, rbMedication, rgThyroid, rgCardio, rgOther,
            rgAshthama, rgKidneyDises, rgDiabetes, rgCancer, rgGynacologist, rgNeurologist,
            rgPalable, rgHypoChondrial, rgNSAID, rgHepetitis, rgFasting, rgDiabetesNew;
    ...
    private RadioButton rb_cad_yes, rb_cad_yes_family, rb_cancer_no_family, rb_cad_no, rb_DM_no_family, rb_DM_yes_family,
            ...
            rbIsCovidDose2, rbIsBoosterDose, rb_palable_yes, rb_fasting_yes, rb_palable_no, rb_HypoChondrial_no, rb_fasting_no,
            rb_HypoChondrial_yes, rb_NSAID_yes, rb_NSAID_no, rb_Hepetitis_yes, rb_Hepetitis_no, rb_edtDiabetesNew_yes, rb_edtDiabetesNew_no, rb_normal, rb_abnormal;
    ...
    private MaterialEditText edt_cancer_history, edt_cad_month, edtAlrgies, edtDiabetes, edt_cad_month_family, edt_cad_year, edtMedication, edtKidneyDes, edt_cad_year_family, edt_cva_month, edt_cva_month_family, edt_copd_month,
            ...
            edt_final_remark, edt_tb_month_family, edt_tb_year_family,

    edt_palable_year, edt_palable_month, edtpalable, edt_HypoChondrial_year, edt_HypoChondrial_month, edtHypoChondrial,
            edt_NSAID_year, edt_NSAID_month, edtNSAID, edt_Hepetitis_year, edt_Hepetitis_month, edtHepetitis,
            edt_edtDiabetesNew_year, edt_edtDiabetesNew_month, edtDiabetesNew;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_health_screening_physical_new_examination_new);
    ...
    private void init() {
        context = HealthScreeningPhysicalExaminationNew_Activity.this;
        ...
        cbNoHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cbNoHistory.isChecked()) {
                    ...
                    Dialog dialog;
                    dialog = new Dialog(HealthScreeningPhysicalExaminationNew_Activity.this);
        ...
        rb_palable_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rb_palable_yes.isChecked() || rb_HypoChondrial_yes.isChecked() || rb_fasting_yes.isChecked()
                        || rb_edtDiabetesNew_yes.isChecked() || rb_Hepetitis_yes.isChecked() || rb_NSAID_yes.isChecked()) {
...
//                edtFasting.setVisibility(View.VISIBLE);
        ...
        rb_edtDiabetesNew_no.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rb_palable_no.isChecked() && rb_HypoChondrial_no.isChecked()
                        && rb_edtDiabetesNew_no.isChecked() && rb_Hepetitis_no.isChecked() && rb_NSAID_no.isChecked()) {
        ...
        rb_NSAID_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rb_palable_yes.isChecked() || rb_HypoChondrial_yes.isChecked()
                        || rb_edtDiabetesNew_yes.isChecked() || rb_Hepetitis_yes.isChecked() || rb_NSAID_yes.isChecked()) {
...
//                    }
                            ...
                            healthList.add(summary);
                        } else if (!rb_edtDiabetesNew_yes.isChecked()) {
                            InsertHealthHistoryNewModel summary = new InsertHealthHistoryNewModel();
                            summary.setRegdid(String.valueOf(RegdId));
                            summary.setPhyExamTypeID("18");
                            summary.setPhyExamStatus("0");
