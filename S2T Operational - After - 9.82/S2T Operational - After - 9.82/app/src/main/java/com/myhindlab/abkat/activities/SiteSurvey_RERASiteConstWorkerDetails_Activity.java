...
import com.myhindlab.abkat.models.GetListOfWorkerDetails;
import com.myhindlab.abkat.models.GetListOfWorkerDetails_Responce;
...
public class SiteSurvey_RERASiteConstWorkerDetails_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    //    private EditText edt_hospitalname, edt_aarogyamittraname;
    private EditText edt_reranumber, edt_numberofworkersreg, edt_numberofworkersnotreg;
...
//            rb_transport_no, rb_transport_yes;
    ...
    private Button btn_submit, btn_done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sitesurvey_rerasiteconstworkerdetails);
...
//
    ...
    private void setDefaults() {
        context = SiteSurvey_RERASiteConstWorkerDetails_Activity.this;
...
//                        .start(SiteSurvey_RERASiteConstWorkerDetails_Activity.this);
            }
        }
...
//                + "/Health Checkup/SiteSurveyPhotos/";
        ...
        InsertConstructionWorkDetailsImage_HandlerAPICall(siteDetails.getReraId(),
...
//                fileType_body, builderID_body, imageFile);
    ...
    private class GetListOfWorkerDetailsAPICall extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            res = WebServiceCall.APICall(ApplicationConstants.GetListOfWorkerDetails, ApplicationConstants.webservice, param);
            return res;
        }
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("Success")) {
                        ...
                        if (workerDetailsList.size() > 0) {
                            ...
                            String isElectricityAvailable = data.getIsElectricityAvailable();
                            String isToiletAvailable = data.getIsToiletAvailable();
...
//
                            ...
                            if (isElectricityAvailable.equalsIgnoreCase("true")) {
                                rb_electricityavailable_yes.setChecked(true);
                                rb_electricityavailable_no.setChecked(false);
                            } else {
                                rb_electricityavailable_yes.setChecked(false);
                                rb_electricityavailable_no.setChecked(true);
                            }

                            if (isToiletAvailable.equalsIgnoreCase("true")) {
                                rb_toiletavailable_yes.setChecked(true);
                                rb_toiletavailable_no.setChecked(false);
                            } else {
                                rb_toiletavailable_yes.setChecked(false);
                                rb_toiletavailable_no.setChecked(true);
                            }
//
//                            if (isTransportNecessary.equalsIgnoreCase("true")) {
//                                rb_transport_yes.setChecked(true);
//                                rb_transport_no.setChecked(false);
//                            } else {
//                                rb_transport_yes.setChecked(false);
...
//
                            ...
                            if (photo3 != null) {
                                ...
                                img_docphoto1.setLongClickable(false);
                            ...
                            img_docphoto2.setLongClickable(false);
...
//                            edt_aarogyamittraname.setClickable(false);
                            ...
                            rb_electricityavailable_no.setClickable(false);
                            rb_electricityavailable_yes.setClickable(false);
                            rb_toiletavailable_no.setClickable(false);
                            rb_toiletavailable_yes.setClickable(false);
//                            rb_transport_no.setClickable(false);
//                            rb_transport_yes.setClickable(false);
                            rb_slab.setLongClickable(false);
                            rb_plinth.setLongClickable(false);
                            rb_digging.setLongClickable(false);
                            img_sitephoto1.setLongClickable(false);
                            img_sitephoto2.setLongClickable(false);
//                            img_docphoto1.setLongClickable(false);
//                            img_docphoto2.setLongClickable(false);
//
...
//                            edt_aarogyamittraname.setFocusable(false);
                            ...
                            rb_electricityavailable_no.setFocusable(false);
                            rb_electricityavailable_yes.setFocusable(false);
                            rb_toiletavailable_no.setFocusable(false);
                            rb_toiletavailable_yes.setFocusable(false);
