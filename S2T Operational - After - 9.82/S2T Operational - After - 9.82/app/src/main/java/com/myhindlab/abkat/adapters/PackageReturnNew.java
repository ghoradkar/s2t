...
public class PackageReturnNew extends RecyclerView.Adapter<PackageReturnNew.MyViewHolder> {

    private List<PacketReturnModel.Output> resultArrayList;
    private Context context;
    private String isAdmin, callType;

    public PackageReturnNew(Context context, List<PacketReturnModel.Output> resultArrayList, String isAdmin, String callType) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int pos) {
        ...
        final PacketReturnModel.Output beneficiaryDetails = resultArrayList.get(position);
        holder.tv_sr_no.setText((position + 1) + "");

        holder.tv_patientName.setText(beneficiaryDetails.getPatientName());
        holder.tv_packetNo.setText(beneficiaryDetails.getPacketNo());
