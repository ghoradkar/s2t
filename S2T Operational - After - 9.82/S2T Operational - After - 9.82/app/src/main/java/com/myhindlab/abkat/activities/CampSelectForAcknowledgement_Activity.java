...
public class CampSelectForAcknowledgement_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_campselect_foracknowledgement);
    ...
    private void setDefaults() {
        context = CampSelectForAcknowledgement_Activity.this;
