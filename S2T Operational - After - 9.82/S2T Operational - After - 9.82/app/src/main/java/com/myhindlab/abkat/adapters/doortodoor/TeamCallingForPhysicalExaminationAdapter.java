...
public class TeamCallingForPhysicalExaminationAdapter extends RecyclerView.Adapter<TeamCallingForPhysicalExaminationAdapter.MyViewHolder> {

    private final List<TeamCallingModel.Output> teamList;
    private Context context;


    public TeamCallingForPhysicalExaminationAdapter(Context context, List<TeamCallingModel.Output> teamList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_d2d_teams_calling, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tvMemberName.setText(data.getTeamNumberName());
        holder.tvDesignation.setText(String.valueOf(data.getDesgName()));
