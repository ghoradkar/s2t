...
public class CampSelectionForPostCamp_Activty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_campselectionfor_postcamp);
    ...
    private void setDefaults() {
        context = CampSelectionForPostCamp_Activty.this;
        ...
        recyclerview_campList.addOnItemTouchListener(
                new RecyclerItemClickListener(context,
                        (view, position) -> {
                            ...
                            startActivity(new Intent(context, PostCampReferredNormalPatientCount_Activity.class)
