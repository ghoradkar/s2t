...
import com.myhindlab.abkat.adapters.PackageAssignmentAdapterNew;
...
public class DailyWorkDashboardActivity extends AppCompatActivity implements CallListAdaptor.Onclicklisner {
    ActivityDailyWorkDashboardBinding binding;
    private UserSessionManager sessionManager;

    private BottomSheetDialog finalAlertDialog;
    ...
    private String fromDate, fromFilterDate, searchFilterId = "0", areaArray, pincodeArray, CampDateFilterToDate, CampDateToDate, CampDate, toDate;


    private ProgressDialog pd;
    private AlertDialog teamDialog;
    private Context mContext;
    private String call_statusid = "1", teamId = "0", landingLabId = "0", mobileNumber, EmpCode, divisionId = "0", referenceId, size, taluka, STATELGDCODE = "2",
            DISTLGDCODE = "0", agentId, oganizationId = "0", DESGID, district, TALLGDCODE = "0", LabCode, campType = "0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDailyWorkDashboardBinding.inflate(getLayoutInflater());
    ...
    void init() {
        mContext = DailyWorkDashboardActivity.this;
...
//                binding.edtSelectdistrict.setText(district);
    ...
    private void setDefault() {
        new GetOrganizationNewForPAgeLoad().execute(EmpCode, DESGID);
...
//            new GetCountDataForTeam().execute(CampDate, CampDateToDate, oganizationId, divisionId, DISTLGDCODE, TALLGDCODE, landingLabId, areaArray.toString(), pincodeArray.toString(), "0", "0", EmpCode, "1");

            binding.llAssignedTeam.setVisibility(View.VISIBLE);
            binding.llAssignmentPending.setVisibility(View.GONE);
            binding.viewAssigned.setVisibility(View.VISIBLE);
            binding.viewUnAssigned.setVisibility(View.GONE);

            binding.edtDivision.setVisibility(View.GONE);
            binding.edtOrganization.setVisibility(View.GONE);
            binding.edtSelectdistrict.setVisibility(View.GONE);
            binding.edtLab.setVisibility(View.GONE);
            binding.rgLogin.setVisibility(View.GONE);


            getCountForPageloadForTeam(
            );

            String formattedFromText = "Camp From Date <font color='red'>*</font>";
            binding.nameFromText.setText(Html.fromHtml(formattedFromText));

            String formattedToText = "Camp To Date <font color='red'>*</font>";
            binding.nameToText.setText(Html.fromHtml(formattedToText));


        } else if (DESGID.equalsIgnoreCase("92") || (DESGID.equalsIgnoreCase("29") || (DESGID.equalsIgnoreCase("160")
                || (DESGID.equalsIgnoreCase("104") || (DESGID.equalsIgnoreCase("162") || DESGID.equalsIgnoreCase("78")
                || DESGID.equalsIgnoreCase("77") || DESGID.equalsIgnoreCase("128") || DESGID.equalsIgnoreCase("30")
                || DESGID.equalsIgnoreCase("108") || DESGID.equalsIgnoreCase("84")||DESGID.equalsIgnoreCase("139")
                ||DESGID.equalsIgnoreCase("136")))))){
        ...
        }else  if (DESGID.equalsIgnoreCase("170") || (DESGID.equalsIgnoreCase("171") || (DESGID.equalsIgnoreCase("182")
        ...
        binding.edtLab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Utilities.isNetworkAvailable(mContext))
                    new GetLandingLabNew().execute(EmpCode);
                else {
        ...
        binding.rbAbkat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (DESGID.equals("86") || DESGID.equals("64") || DESGID.equals("35") || DESGID.equals("129") || DESGID.equals("146")) {
                    ...
                    if (searchFilterId.equals("0")){
                        getCountForPageloadForTeam(

                        );

                    }else if (searchFilterId.equals("1")){
                        getCountForTeam(
...
//                                    TALLGDCODE = String.valueOf(t.getTallgdcode());
                ...
                startActivity(new Intent(mContext, RejectedBeneficiaryListActivity.class)
                        ...
                        .putExtra("filterType", searchFilterId)
                        .putExtra("campType", campType)
...
//                            new GetCountDataForTeam().execute(CampDate, CampDateToDate, oganizationId, divisionId, DISTLGDCODE, TALLGDCODE, landingLabId, areaArray.toString(), pincodeArray.toString(), "0", "0", EmpCode, "1");
                                            ...
                                            getCountForTeam(
                                                ...
                                                || DESGID.equalsIgnoreCase("108") || DESGID.equalsIgnoreCase("84")||DESGID.equalsIgnoreCase("139")
                                                ||DESGID.equalsIgnoreCase("136")))))) {
//                            new GetCountData().execute(CampDate, CampDateToDate, oganizationId, divisionId, DISTLGDCODE, TALLGDCODE, landingLabId, areaArray.toString(), pincodeArray.toString(), "0", "0", EmpCode, "1");
...
//            @Override
//            public void onClick(View view) {
//                BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(DailyWorkDashboardActivity.this);
...
//                            Utilities.showAlertDialog(mContext, "Alert", "Please Select from Date", false);
//                            return;
//                        }
//                        if (ToDate.getText().toString().isEmpty()) {
//                            Utilities.showAlertDialog(mContext, "Alert", "Please Select to date", false);
//                            return;
//                        }
//
//
...
//
////                        if (pincodeList == null) {
////                            Utilities.showAlertDialog(mContext, "Alert", "Please select pincode", false);
////                            return;
////                        }
//
//
...
//                        }
//
//                        finalAlertDialog = bottomSheetDialog;
//
//
//                        if (DESGID.equals("86") || DESGID.equals("64") || DESGID.equals("35") || DESGID.equals("129") || DESGID.equals("146")) {
////                            new GetCountDataForTeam().execute(CampDate, CampDateToDate, oganizationId, divisionId, DISTLGDCODE, TALLGDCODE, landingLabId, areaArray.toString(), pincodeArray.toString(), "0", "0", EmpCode, "1");
...
//        });
    ...
    private void getReportlist() {
        final ProgressDialog progressDialog = new ProgressDialog(DailyWorkDashboardActivity.this);
            ...
            public void onResponse(Call<ReportlistResponse> call, Response<ReportlistResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    if (status.equalsIgnoreCase("Success")) {
                        ...
                        CallListAdaptor callListAdaptor = new CallListAdaptor(DailyWorkDashboardActivity.this, reportdatalist, DailyWorkDashboardActivity.this);
//                        binding.rvReportlist.setAdapter(callListAdaptor);

                    } else {
                        CallListAdaptor callListAdaptor = new CallListAdaptor(DailyWorkDashboardActivity.this, new ArrayList<>(), DailyWorkDashboardActivity.this);
//                        binding.rvReportlist.setAdapter(callListAdaptor);
                    }
                }
            }
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (msg.equalsIgnoreCase("success")) {
                            ...
                            Utilities.showAlertDialog(DailyWorkDashboardActivity.this, "Success", data, true);


                        } else {

                            Utilities.showAlertDialog(DailyWorkDashboardActivity.this, "Fail", data, false, "Try Again!", new DialogInterface.OnClickListener() {
                                @Override
...
//    }
    ...
    private void showTrenchListDialog(final List<AppointmentListModel.Output> trenchList) {
        AlertDialog.Builder builderSingle = new AlertDialog.Builder(DailyWorkDashboardActivity.this);
        builderSingle.setTitle("Select Call Status");
        builderSingle.setCancelable(false);
        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(DailyWorkDashboardActivity.this, R.layout.list_row);
...
//
                        ...
                        if (assignteamlist.size() > 0) {
                            ...
                            Utilities.showToastMessage(R.string.msgt_emptylist, DailyWorkDashboardActivity.this, false);
                        }
                    } else {
                        Utilities.showAlertDialog(DailyWorkDashboardActivity.this, "Fail", message, false);
                ...
                Utilities.showAlertDialog(DailyWorkDashboardActivity.this, "Please Try Again", "Server Not Responding", false);
            }
        }
        ...
        private void showAssignedTeamListDialog(final ArrayList<TeamsDetailsModel.OutputBean> assignteamlist) {
            ...
            rvList.setLayoutManager(new LinearLayoutManager(DailyWorkDashboardActivity.this));

            rvList.setAdapter(new TeamsDetailsAssignedReportDeliveryAdapter(assignteamlist));

            rvList.addOnItemTouchListener(
                    new RecyclerItemClickListener(DailyWorkDashboardActivity.this,
...
//                        startActivity(intent);
    ...
    public void onclick(OutputItem item) {
        ...
        Intent intent = new Intent(DailyWorkDashboardActivity.this, AppoinmentConfirmationActivity.class);
...
//                            showDistrictListDialog(districtList);
    ...
    public class GetPincodeList extends AsyncTask<String, Void, String> {

        RecyclerView recyclerView;

        public GetPincodeList(RecyclerView recyclerView) {
            this.recyclerView = recyclerView;
        }
        ...
        protected String doInBackground(String... params) {
            String res = "";
            List<ParamsPojo> param = new ArrayList<ParamsPojo>();
            param.add(new ParamsPojo("T_AreaofPincode", params[0]));


            res = WebServiceCall.APICall(ApplicationConstants.GetPincode, ApplicationConstants.webservice_d2d, param);
            return res;
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                if (!result.equals("")) {
                    ...
                    PincodeListModel pojoDetails = new Gson().fromJson(result, PincodeListModel.class);
                    type = pojoDetails.getStatus();
                    message = pojoDetails.getMessage();
                    if (type.equalsIgnoreCase("success")) {
    ...
    public class GetLandingLabNew extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if (BuildConfig.isBeta) {
                res = WebServiceCall.APICall(ApplicationConstants.GetLabforD2DCampCoordinator, ApplicationConstants.webservice_d2d, param);
            } else {
                res = WebServiceCall.APICall(ApplicationConstants.GetLabforD2DCampCoordinator, ApplicationConstants.webservice_d2d, param);
            }
            return res;
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                if (result != null && result.length() > 0 && !result.equalsIgnoreCase("[]")) {
                    ...
                    CountsForDailyWorkDashboardModel countsForDailyWorkDashboardModel = new Gson().fromJson(result, CountsForDailyWorkDashboardModel.class);
                    type = countsForDailyWorkDashboardModel.getStatus();
                    message = countsForDailyWorkDashboardModel.getMessage();
                    if (type.equalsIgnoreCase("success")) {

                        countList = countsForDailyWorkDashboardModel.getOutput();
                        if (countList != null && countList.size() > 0) {

//                            rv_d2dTeams.setAdapter(new AdminActiveInactiveTeamAdapter(mContext, countList));


                            int t = 0;
                            int p = 0;

                            for (CountsForDailyWorkDashboardModel.Output output :
                                    countList) {
...
//                                p = p + (output.getNonWorkingTeamCount());
                                ...
                                if (output.getSequenceNo() == 7) {

                                    binding.tvAssigned.setText("" + output.getPatientCount());

                                } else if (output.getSequenceNo() == 2) {

                                    binding.interestedInScreening.setText("" + output.getPatientCount());

                                } else if (output.getSequenceNo() == 3) {

                                    binding.tvNotScreening.setText("" + output.getPatientCount());

                                } else if (output.getSequenceNo() == 4) {

                                    binding.tvDeniedForScreening.setText("" + output.getPatientCount());

                                } else if (output.getSequenceNo() == 5) {

                                    binding.reScreenedBeneficiary.setText("" + output.getPatientCount());

                                } else if (output.getSequenceNo() == 6) {

                                    binding.reScreenedPendingCard.setText("" + output.getPatientCount());

                                } else if (output.getSequenceNo() == 1) {

                                    binding.assignedBene.setText("" + output.getPatientCount());

                                } else if (output.getSequenceNo() == 8) {

                                    binding.tvUnassigned.setText("" + output.getPatientCount());

                                } else if (output.getSequenceNo() == 0) {
                                    binding.rejectedBeneficiary.setText("" + output.getPatientCount());
...
//                        finalAlertDialog.dismiss();
                        ...
                        if (countsForDailyWorkDashboardModels.size() > 0) {
                            for (CountsForDailyWorkDashboardModel.Output o : countsForDailyWorkDashboardModels) {
                                searchFilterId = "1";

                                binding.fromDate.setText(CampDate);
                                binding.Todate.setText(CampDateToDate);
...
//                                binding.tvDeniedfor.setText("0");
            ...
            public void onFailure(Call<CountsForDailyWorkDashboardModel> call, Throwable t) {
                // Dismiss the progress dialog even if the request fails
                progressDialog.dismiss();
...
//
    ...
    public class GetOrganizationNewForPAgeLoad extends AsyncTask<String, Void, String> {
...
//                            organizationList.add(0, new SubOrganizationModel("0", "All"));
                            ...
                            if (pojoDetails.getOutput().size() > 0) {
                                ...
                                binding.edtOrganization.setText(output.getSubOrgName());
...
//                            showOrganizationListDialog(organizationList);
    ...
    private void getCountForPageload() {
        final ProgressDialog progressDialog = new ProgressDialog(DailyWorkDashboardActivity.this);
        progressDialog.setMessage("Please wait . . . ");
        progressDialog.setCancelable(false);
        progressDialog.show();
        ApiInterface apiInterface = ApiClient.getD2DClient().create(ApiInterface.class);
        apiInterface.getCountForPageload(CampDate, CampDateToDate, oganizationId, "0", DISTLGDCODE, landingLabId, "0", "0", EmpCode, "1", DESGID, campType).enqueue(new Callback<CountsForDailyWorkDashboardModel>() {
            @Override
            public void onResponse(Call<CountsForDailyWorkDashboardModel> call, Response<CountsForDailyWorkDashboardModel> response) {
    ...
    private void getCountForPageloadForTeam() {
        ApiInterface apiInterface = ApiClient.getD2DClient().create(ApiInterface.class);
        apiInterface.getCountForPageloadForTeam(CampDate, CampDateToDate,  "0", "0", EmpCode, "1", "0").enqueue(new Callback<CountsForDailyWorkDashboardModel>() {
            @Override
            public void onResponse(Call<CountsForDailyWorkDashboardModel> call, Response<CountsForDailyWorkDashboardModel> response) {
    ...
    protected void onResume() {
        ...
        if (Utilities.isNetworkAvailable(mContext)) {
            if (DESGID.equals("86") || DESGID.equals("64") || DESGID.equals("35") || DESGID.equals("129") || DESGID.equals("146")) {
                ...
                if (searchFilterId.equalsIgnoreCase("0")) {
