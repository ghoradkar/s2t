...
import com.myhindlab.abkat.omron.models.PeripheralDevice;
...
public class PreferencesManager {
    ...
    public String getPartnerKey() {
        if (pref != null) {
            return pref.getString(KEY_PARTNER_KEY_VALUE,"8ACE95FC-D532-4004-A88E-873921B18539");
        } else {
            return "8ACE95FC-D532-4004-A88E-873921B18539";
        }
    }
}