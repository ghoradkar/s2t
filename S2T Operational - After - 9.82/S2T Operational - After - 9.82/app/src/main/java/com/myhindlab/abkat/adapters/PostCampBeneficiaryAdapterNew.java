...
public class PostCampBeneficiaryAdapterNew extends RecyclerView.Adapter<PostCampBeneficiaryAdapterNew.MyViewHolder> {

    private List<PostCampBeneficiaryListModel.OutputBean> resultArrayList;
    private Context context;
    private String isAdmin, callType;

    public PostCampBeneficiaryAdapterNew(Context context, List<PostCampBeneficiaryListModel.OutputBean> resultArrayList, String isAdmin, String callType) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.list_row_post_camp_patient_new, parent, false);
...
//9765424584
        ...
        holder.ll_row.setOnClickListener(v ->
                context.startActivity(new Intent(context, PostCampThumbSignatureUpload_Activity.class)
