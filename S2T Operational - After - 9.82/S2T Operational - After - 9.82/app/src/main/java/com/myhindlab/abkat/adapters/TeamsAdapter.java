...
public class TeamsAdapter extends RecyclerView.Adapter<TeamsAdapter.MyViewHolder> {
    ...
    private final ArrayList<GetTeamsModel.OutputBean> teamList;
    private Context context;
    public TeamEvents teamEvents;

    public interface TeamEvents {
        void onTeamSelected(GetTeamsModel.OutputBean outputBean);
    }

    public TeamsAdapter(ArrayList<GetTeamsModel.OutputBean> teamList, TeamEvents teamEvents) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        GetTeamsModel.OutputBean data = teamList.get(holder.getAbsoluteAdapterPosition());
        holder.tvTeamId.setText(data.getTeamname());
