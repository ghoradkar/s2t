...
public class CampSelectionForPatientAttendance_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_campselection_forpatientregistration);
    ...
    private void setDefaults() {
        context = CampSelectionForPatientAttendance_Activity.this;
