...
public class CampCalendarAdapter extends BaseAdapter {
    ...
    public CampCalendarAdapter(Context context, Calendar month, ArrayList<CampCalenderDatesModel> campDateCountList) {
        this.month = month;
