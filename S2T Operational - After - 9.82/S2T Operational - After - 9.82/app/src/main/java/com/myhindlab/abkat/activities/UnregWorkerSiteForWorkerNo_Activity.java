...
public class UnregWorkerSiteForWorkerNo_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unregworkersite_forworkerno);
    ...
    private void setDefaults() {
        context = UnregWorkerSiteForWorkerNo_Activity.this;
