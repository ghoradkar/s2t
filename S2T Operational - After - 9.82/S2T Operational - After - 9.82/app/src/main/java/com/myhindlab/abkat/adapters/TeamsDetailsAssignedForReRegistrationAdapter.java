...
public class TeamsDetailsAssignedForReRegistrationAdapter extends RecyclerView.Adapter<TeamsDetailsAssignedForReRegistrationAdapter.MyViewHolder> {

    private final ArrayList<TeamsDetailsModel.OutputBean> teamList;

    public TeamsDetailsAssignedForReRegistrationAdapter(ArrayList<TeamsDetailsModel.OutputBean> teamList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tvTeamId.setText("( Team Number :- " + data.getTeamName() + ")" );
