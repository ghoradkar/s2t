...
public class BPMSendPacket {
    ...
    public final static byte Packet_Type_Start = 0x01;
    public final static byte Packet_Type_Stop = 0x02;
    public final static byte Packet_Type_Data = 0x03;
    public final static byte Packet_Type_Confirm = 0x05;
    ...
    //
    public BPMSendPacket(byte type) {
        initData(type);
    }
    ...
    private void initData(byte type) {
        if (Packet_Type_Info != type &&
                Packet_Type_Start != type &&
                Packet_Type_Stop != type &&
                Packet_Type_Data != type &&
                Packet_Type_Confirm != type) {
            return;
        }
        ...
        Log.e("BGMSendPacket", "in initData,  data[3] = " + data[3]);
    }
