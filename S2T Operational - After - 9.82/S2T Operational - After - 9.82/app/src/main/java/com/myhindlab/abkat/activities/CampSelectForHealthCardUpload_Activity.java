...
public class CampSelectForHealthCardUpload_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_campselect_forhealthcardupload);
    ...
    private void setDefaults() {
        context = CampSelectForHealthCardUpload_Activity.this;
