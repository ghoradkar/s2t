...
public class PhleboListDetailsAdapter extends RecyclerView.Adapter<PhleboListDetailsAdapter.MyViewHolder> {

    private final ArrayList<PhleboDetailsModel.OutputBean> phleboList;

    public PhleboListDetailsAdapter(ArrayList<PhleboDetailsModel.OutputBean> phleboList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        PhleboDetailsModel.OutputBean data = phleboList.get(position);
