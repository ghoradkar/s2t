...
public class CampSelectionForItemconsumption_Activity extends AppCompatActivity {
    ...
    private void setDefaults() {
        context = CampSelectionForItemconsumption_Activity.this;
                ...
                new RecyclerItemClickListener(context,
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, final int position) {
                                ...
                                startActivity(new Intent(context, InventoryItemConsumption_Activity.class)
...
//            param.add(new ParamsPojo("CampDATE", "2019/06/16"));
