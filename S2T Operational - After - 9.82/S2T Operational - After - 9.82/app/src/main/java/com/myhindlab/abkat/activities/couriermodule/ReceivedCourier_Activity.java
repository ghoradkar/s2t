...
import com.myhindlab.abkat.adapters.couriermodule.ReceivedCourierAdapter;
...
public class ReceivedCourier_Activity extends Activity implements View.OnClickListener {
    ...
    private TextView tv_select_lab, tv_lab;
    ...
    private void init() {
        context = ReceivedCourier_Activity.this;
    ...
    private void getReceivedCourierApiCall() {
        if (Utilities.isNetworkAvailable(context)) {
            new GetReceivedCourierDetails().execute(userId,
                    desgId,
                    labcode,
    ...
    public static class GetReceivedCourierDetails extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            param.add(new ParamsPojo("ToDate", params[4]));
            res = WebServiceCall.HLLAPICall(ApplicationConstants.GetReceivedCourierDetails, param);
            return res;
        }
            ...
            try {
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        Utilities.showAlertDialog(context, "Fail", "Received Courier Details Not Found", false);
                        rv_courierList.setAdapter(new ReceivedCourierAdapter(
                                receivedCourierArray,
                                context,
                                userId,
