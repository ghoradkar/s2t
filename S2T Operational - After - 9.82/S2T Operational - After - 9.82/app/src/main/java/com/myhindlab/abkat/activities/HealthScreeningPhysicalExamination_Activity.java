...
public class HealthScreeningPhysicalExamination_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private MaterialEditText edt_cancer_history, edt_cad_month, edt_cad_month_family, edt_cad_year, edt_cad_year_family, edt_cva_month, edt_cva_month_family, edt_copd_month, edt_copd_month_family, edt_cva_year, edt_cva_year_family, edt_copd_year, edt_copd_year_family, edt_htn_month, edt_htn_month_family, edt_htn_year, edt_htn_year_family, edt_cancer_year, edt_cancer_month_family, edt_cancer_year_family, edt_cancer_month,
            edt_lumb_observed, edt_anaemia_month, edt_anaemia_year, edt_mi_month, edt_mi_year, edt_ckd_month, edt_ckd_year, edt_DM_month, edt_DM_month_family, edt_DM_year_family, edt_DM_year, edt_personal_observation, edt_comment, edt_final_remark;
    private CardView cv_breast_screening;


    private TextView tv_gynaecologicalexamination, tv_view_report;
    ...
    String lungComment, abnormalComment, versionName, cvsComment, GITComment, skinInfection, gynaComment, cnsComment, finalComment, jsonstring, dateString, distlgdcode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_health_screening_physical_examination);
    ...
    private void init() {
        context = HealthScreeningPhysicalExamination_Activity.this;
            ...
            try {
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        edt_systolic.setText(patinetHistoryList.get(0).getSystolic());
                        edt_diastolic.setText(patinetHistoryList.get(0).getDiastolic());
                        edt_f.setText(patinetHistoryList.get(0).getBloodSugar_F());
                        edt_pp.setText(patinetHistoryList.get(0).getBloodSugar_PP());
                        edt_r.setText(patinetHistoryList.get(0).getBloodSugar_R());
    ...
    public class InsertBasicInfoMale extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if (BuildConfig.isBeta) {
                ...
                res = WebServiceCall.APICall(ApplicationConstants.InsertBasicInfoMale_VersionNo, ApplicationConstants.webservice_d2d, param);

            } else {

//                res = WebServiceCall.APICall(ApplicationConstants.InsertBasicInfoMale, ApplicationConstants.webservice, param);
    ...
    public class InsertBasicInfoFeMale extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if (BuildConfig.isBeta) {
                ...
                res = WebServiceCall.APICall(ApplicationConstants.InsertBasicInfoFemale_VersionNo, ApplicationConstants.webservice_d2d, param);
