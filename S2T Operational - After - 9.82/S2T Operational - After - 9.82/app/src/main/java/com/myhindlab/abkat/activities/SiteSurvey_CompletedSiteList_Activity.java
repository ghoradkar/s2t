...
public class SiteSurvey_CompletedSiteList_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sitesurvey_completedsitelist);
    ...
    private void setUpToolbar() {
        ...
        getSupportActionBar().setTitle("Completed Site Survey");
    ...
    private void setDefaults() {
        context = SiteSurvey_CompletedSiteList_Activity.this;
            ...
            try {
                if (!res.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        dataList = pojoDetails.getSiteCompletedOutput();
