...
public class ActivityListAdapter extends RecyclerView.Adapter<ActivityListAdapter.VersionViewHolder>{
    ...
    @Override
    public void onBindViewHolder(VersionViewHolder versionViewHolder, int pos) {
        int position=versionViewHolder.getAbsoluteAdapterPosition();
        ...
        if(measurement > 0)
            versionViewHolder.llBg.setBackgroundColor(context.getResources().getColor(R.color.greylight));
