...
public class AssignTeamConfirmatoryTestActivity extends AppCompatActivity implements TeamsAdapter.TeamEvents {
    ...
    private String beni_no,regId,reg_no,campId = "0",teamidForcamp,teamName,resourceId,assignedteamno,isteamAssign= "0", sAdmin,assignedUserId1,assignedUserId2, UserId, campTypeId, EmpCode, STATELGDCODE = "2", DESGID, teamId = "0",
            district, TALLGDCODE,CampId, regNo,mobileNumber, DISTLGDCODE, taluka, LabCode, CampDate, CampDateToDate, AssignedId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appointment_confirmatory_test_assign_team);
    ...
    private void initView() {
        context = AssignTeamConfirmatoryTestActivity.this;
...
//            edt_Address.setText(beneficiaryFromCommonbeneficiary.geta());
            ...
            new GetDependentInfo().execute(beneficiary.getRegdid(), beneficiary.getRegdno());
...
//                    dpd1.getDatePicker().setMaxDate(System.currentTimeMillis() + (1000 * 60 * 60));
        ...
        tv_viewdetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(AssignTeamConfirmatoryTestActivity.this, HealthScreeningSamplecollectionConfirmatory_Activity.class);
...
//            pd.show();
        ...
        protected String doInBackground(String... params) {
            ...
            res = WebServiceCall.APICall(ApplicationConstants.GetT2T_CT_BeneficiaryDetailsforAssignTeamid, ApplicationConstants.webservice_d2d, param);
            return res;
        }
...
//                        rv_dependent.setAdapter(new Dependent_Adapter_For_Search_Beneficiary_Confirmatory(context, new ArrayList<>(), AssignTeamConfirmatoryTestActivity.this::onBeneficiaryClick));
    ...
    private class InsertCTData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            res = WebServiceCall.APICall(ApplicationConstants.Insert_T2T_CT_TeamandBeneficiaryMapping, ApplicationConstants.webservice_d2d, param);
            return res;
        }
...
//                                finish();
        ...
        edt_search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                if (query.toString().isEmpty()) {
                    rvList.setAdapter(new TeamsAdapter(teamList, AssignTeamConfirmatoryTestActivity.this));
                    return;
                }
                ...
                if (!query.toString().equals("")) {
                    ...
                    rvList.setAdapter(new TeamsAdapter(searchedTestList, AssignTeamConfirmatoryTestActivity.this));
                } else {
                    rvList.setAdapter(new TeamsAdapter(teamList, AssignTeamConfirmatoryTestActivity.this));
                }
    ...
    private void getMedicineCTDetails(String regno) {
        ProgressDialog progressDialog = new ProgressDialog(AssignTeamConfirmatoryTestActivity.this);
...
//                        alertDialog.show();
                        ...
                        Utilities.showAlertDialog(AssignTeamConfirmatoryTestActivity.this, "Fail", message, false);
                    }
                } else {
                    Utilities.showAlertDialog(AssignTeamConfirmatoryTestActivity.this, "Fail", "Details Not Found", false);
                }
            }
            ...
            public void onFailure(Call<CTMedicineDetailsModel> call, Throwable t) {
                progressDialog.dismiss();
                Utilities.showAlertDialog(AssignTeamConfirmatoryTestActivity.this, "Please Try Again", "Server not responding", false);
            }
        });
    }
