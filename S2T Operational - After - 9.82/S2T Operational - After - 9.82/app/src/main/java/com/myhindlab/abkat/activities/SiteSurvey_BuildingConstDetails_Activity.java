...
public class SiteSurvey_BuildingConstDetails_Activity extends AppCompatActivity implements View.OnClickListener {

    private Context context;
    private UserSessionManager session;
    private ProgressDialog pd;

    //    private TextView tv_constrictiontitle;
    private EditText edt_selectdistrict, edt_sitename, edt_siteaddress,
...
//    private String districtName = "", districtCode = "";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sitesurvey_builderconstdetails);
    ...
    private void init() {
//        tv_constrictiontitle = findViewById(R.id.tv_constrictiontitle);
...
//        btn_next = findViewById(R.id.btn_next);
    ...
    private void setDefaults() {
        context = SiteSurvey_BuildingConstDetails_Activity.this;
        ...
        try {
            ...
            for (int j = 0; j < user_info.length(); j++) {
                ...
                String userID = json.getString("EmpCode");
                String districtName = json.getString("district");
                String districtCode = json.getString("DISTLGDCODE");

                siteDetails.setUserID(userID);
                siteDetails.setDISTNAME(districtName);
                siteDetails.setDISTLGDCODE(districtCode);

                edt_selectdistrict.setText(districtName);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//            tv_constrictiontitle.setText("Constriction Site Details (Provided by Surveyor)");
...
//
//        } else {
//            tv_constrictiontitle.setText("Constriction Site Details (Provided by RERA Data)");
...
//        }
    ...
    private void setEventHandler() {
        edt_selectdistrict.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_proceed:
                ...
                if (siteDetails.getDISTLGDCODE() == null
                        || siteDetails.getDISTNAME() == null
                        || siteDetails.getDISTLGDCODE().equalsIgnoreCase("")
                        || siteDetails.getDISTNAME().equalsIgnoreCase("")) {
                    edt_selectdistrict.setError("Please select district");
                    edt_selectdistrict.requestFocus();
                    return;
                }
                ...
                if (edt_sitename.getText().toString().trim().isEmpty()) {
                    edt_sitename.setError("Please enter site name");
...
//                break;
    ...
    private void insertAPICall() {
        ...
        siteDetails.setSiteName(edt_sitename.getText().toString().trim());
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("Success")) {
                        if (!message.equalsIgnoreCase("")) {
                            ...
                            startActivity(new Intent(context, SiteSurvey_BuildingConstContractorDetails_Activity.class)
                                    .putExtra("siteDetails", siteDetails));
                            finish();
                        } else {
    ...
    private void showDistrictListDialog(final ArrayList<DistrictList_Model> districtList) {
        ...
        builderSingle.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int pos) {
                edt_selectdistrict.setText(districtList.get(pos).getDISTNAME());
                String districtCode = districtList.get(pos).getDISTLGDCODE();
                String districtName = districtList.get(pos).getDISTNAME();
...
//                }
//                if (edt_pincode.getText().toString().trim().length() <= 0) {
