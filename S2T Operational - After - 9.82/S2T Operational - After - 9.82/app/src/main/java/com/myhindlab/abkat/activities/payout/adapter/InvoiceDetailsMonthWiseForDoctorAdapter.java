...
public class InvoiceDetailsMonthWiseForDoctorAdapter extends RecyclerView.Adapter<InvoiceDetailsMonthWiseForDoctorAdapter.myview> {
    List<InvoiceMonthWiseDetailsnModel.Output> invoiceList;

    Context context;


    public InvoiceDetailsMonthWiseForDoctorAdapter(Context context, List<InvoiceMonthWiseDetailsnModel.Output> invoiceList) {
    ...
    public myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_row_raise_request_for_doctor, parent, false);
    ...
    public void onBindViewHolder(@NonNull myview holder, int position) {
        ...
        holder.tv_reg_beneficiary.setText(""+item.getTotalBeneficiaries());
        holder.tv_rejected_bene.setText(""+item.getTotalIndividualRejected());
        holder.tv_woker_count.setText(""+item.getBillablesSameDay());
        holder.tv_dependent_count.setText(""+item.getBillablesAnotherDay());
