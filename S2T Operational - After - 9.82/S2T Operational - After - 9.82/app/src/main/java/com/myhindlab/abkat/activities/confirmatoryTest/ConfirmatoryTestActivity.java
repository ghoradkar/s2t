...
public class ConfirmatoryTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirmatory_test);
        initView();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void initView() {
        context = ConfirmatoryTestActivity.this;
...
//                    confirmatoryTestAdapter = new ConfirmatoryTestAdapter(context, new ArrayList<>());
        ...
        tv_District.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Utilities.isNetworkAvailable(context)) {
                    new GetDistrictList().execute(STATELGDCODE, "0", "0");
                } else {
        ...
        searchview_campname.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (facilitySearchedList.size() == 0) {
                    ...
                    confirmatoryTestAdapter = new ConfirmatoryTestAdapter(context, facilitySearchedList);
                    rv_patient_list.setAdapter(confirmatoryTestAdapter);
                } else {
                    confirmatoryTestAdapter = new ConfirmatoryTestAdapter(context, facilitySearchedList);
                    rv_patient_list.setAdapter(confirmatoryTestAdapter);
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (newText.equals("")) {
                    ...
                    confirmatoryTestAdapter = new ConfirmatoryTestAdapter(context, campBeneficiaryList);
                    rv_patient_list.setAdapter(confirmatoryTestAdapter);
