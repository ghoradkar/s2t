...
import com.myhindlab.abkat.activities.confirmatoryTest.adapter.Dependent_Adapter_For_Search_Beneficiary_Confirmatory_New_Adapter;
...
public class AppointmentConfirmationConfirmatoryNewActivity extends AppCompatActivity implements Dependent_Adapter_For_Search_Beneficiary_Confirmatory_New_Adapter.DepedentDetailsConfimatory {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appointment_confirmatory_test_new);
    ...
    private void initView() {
        context = AppointmentConfirmationConfirmatoryNewActivity.this;
    ...
    private void submitData() {
        ...
        if (dependentList != null) {
            for (DependentForSearchBeneficiaryModel o : dependentList) {
                ...
                jsonObject.addProperty("T2T_Order_Id", o.getT2t_Order_Id());
                jsonObject.addProperty("TreatmentID", o.getTreatmentID());
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        if (dependentList != null && dependentList.size() > 0) {
                            ...
                            if (dependentForSearchBeneficiaryModel.getOutput().size() > 0) {
                                ...
                                t2tOrderId = output.getT2t_Order_Id();
...
//                            campCoordinatorNotWorkingTeamAdapter = new CampCoordinatorNotWorkingTeamAdapter(d2dWorkingTeamModel.getOutput());
                            ...
                            rv_dependent.setAdapter(new Dependent_Adapter_For_Search_Beneficiary_Confirmatory_New_Adapter(context, dependentList, AppointmentConfirmationConfirmatoryNewActivity.this::onBeneficiaryClick,DISTLGDCODE));
...
//                                    finish();
                            ...
                            rv_dependent.setAdapter(new Dependent_Adapter_For_Search_Beneficiary_Confirmatory_New_Adapter(context, new ArrayList<>(), AppointmentConfirmationConfirmatoryNewActivity.this::onBeneficiaryClick,DISTLGDCODE));
...
//            param.add(new ParamsPojo("Type", type_data));
            res = WebServiceCall.APICall(ApplicationConstants.UpdateT2T_CT_AppointmentDate_V2, ApplicationConstants.webservice_d2d, param);
            return res;
        }
