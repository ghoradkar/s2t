...
public class TeamCallingAdapter extends RecyclerView.Adapter<TeamCallingAdapter.MyViewHolder> {

    private final List<TeamCallingModel.Output> teamList;
    private Context context;


    public TeamCallingAdapter(Context context, List<TeamCallingModel.Output> teamList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_ct_medicine, parent, false);
