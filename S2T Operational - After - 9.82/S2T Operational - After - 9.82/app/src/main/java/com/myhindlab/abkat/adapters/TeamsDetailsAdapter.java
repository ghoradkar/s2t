...
public class TeamsDetailsAdapter extends RecyclerView.Adapter<TeamsDetailsAdapter.MyViewHolder> {

    private final ArrayList<TeamsDetailsModel.OutputBean> teamList;

    public TeamsDetailsAdapter(ArrayList<TeamsDetailsModel.OutputBean> teamList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_teams_remove_, parent, false);
