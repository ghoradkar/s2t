...
import com.myhindlab.abkat.activities.PostCampDoctorRemarkPhotoUpload_Activity;
import com.myhindlab.abkat.activities.PostCampThumbSignatureUpload_Activity;
import com.myhindlab.abkat.activities.PostCampThumbSignatureUpload_ActivityNew;
import com.myhindlab.abkat.models.PostCampBeneficiaryListModel;

import java.util.List;

public class PostCampBeneficiaryAdapter extends RecyclerView.Adapter<PostCampBeneficiaryAdapter.MyViewHolder> {

    private List<PostCampBeneficiaryListModel.OutputBean> resultArrayList;
    private Context context;
    private String isAdmin, callType;

    public PostCampBeneficiaryAdapter(Context context, List<PostCampBeneficiaryListModel.OutputBean> resultArrayList, String isAdmin, String callType) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.list_row_post_camp_patient, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int pos) {
        ...
        holder.tv_patient.setText(beneficiaryDetails.getBeneficiaryName());
        holder.tv_age.setText(beneficiaryDetails.getAge());
...
//        }
        ...
        if ( beneficiaryDetails.getPostCampAcknowlegedmentFile()==null ||
                beneficiaryDetails.getPostCampAcknowlegedmentFile().equals("NA") && beneficiaryDetails.getOTPStatus().equals("NA"))
...
//            holder.imv_fingerprint.setColorFilter(ContextCompat.getColor(context, R.color.green));
        ...
        holder.imv_remark.setOnClickListener(v ->
        ...
        holder.imv_fingerprint.setOnClickListener(v ->
                context.startActivity(new Intent(context, PostCampThumbSignatureUpload_ActivityNew.class)
                        .putExtra("beneficiaryDetails", beneficiaryDetails)
                        .putExtra("isAdmin", isAdmin))
        );
