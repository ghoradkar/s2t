...
public class RejectedBeneficiaryListAdapter extends RecyclerView.Adapter<RejectedBeneficiaryListAdapter.MyViewHolder>{
    ...
    public RejectedBeneficiaryListAdapter(Context context, List<DependentModel> resultArrayList, DependentEvents dependentEvents) {
