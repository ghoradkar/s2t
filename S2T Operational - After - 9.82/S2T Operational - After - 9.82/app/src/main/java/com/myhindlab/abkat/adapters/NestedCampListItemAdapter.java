...
public class NestedCampListItemAdapter extends RecyclerView.Adapter<NestedCampListItemAdapter.MyViewHolder> {

    private List<NestedCampListModel.Output> resultArrayList;
    private UserSessionManager session;
    private Context context;
    private String DESGID;
    private int campTypeId = 0;

    public NestedCampListItemAdapter(Context context, List<NestedCampListModel.Output> resultArrayList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int pos) {
        ...
        final NestedCampListModel.Output campDetails = resultArrayList.get(position);
        holder.tv_districtname.setText(campDetails.getDistname());
        holder.tv_date.setText(campDetails.getCampDate());
        holder.tv_campid.setText(String.valueOf(campDetails.getCampId()));
...
//        holder.tv_location.setText(campDetails.getCampLocation());
        holder.tv_registered.setText(String.valueOf(campDetails.getRegisterworkers()));
        ...
        holder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (DESGID.equals("63") || DESGID.equals("24") || DESGID.equals("26")) {
