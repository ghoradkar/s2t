...
import com.myhindlab.abkat.adapters.CSCCampRequestListAdapterForCC;
...
public class CampRequestActivityForCC extends AppCompatActivity implements CSCCampRequestListAdapterForCC.UpdateCamp {
    ...
    public void initView() {
        ...
        context = CampRequestActivityForCC.this;
    ...
    private class GetRequestedCamp extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
           ...
           // res = WebServiceCall.APICall(ApplicationConstants.GETCSCPreCampInfoForApproval, ApplicationConstants.webservice, paramsPojos);
            res = WebServiceCall.APICall(ApplicationConstants.GETCSCPreCampInfoForApprovalListForCampCoordinator_V1, ApplicationConstants.webservice_d2d, paramsPojos);
        ...
        protected void onPostExecute(String result) {
            ...
            Log.d("GETCSCPreCamp", "onPostExecute: " + result);
                ...
                try {
                    ...
                    if (cscPreCampInfoForApprovalModelList.getStatus().equalsIgnoreCase("Success")) {
                        ...
                        if (cscPreCampInfoForApprovalModelList.getOutput().size() > 0) {
                            recyclerView.setAdapter(new CSCCampRequestListAdapterForCC(context, cscPreCampInfoForApprovalModelList.getOutput(), CampRequestActivityForCC.this::onUpdateCamp));
                            ...
                            appCompatSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                ...
                                public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                    ...
                                    if (i == 1) {
                                        ...
                                        recyclerView.setAdapter(new CSCCampRequestListAdapterForCC(context, filterCscPreCampInfoForApprovalModelList, CampRequestActivityForCC.this::onUpdateCamp));
