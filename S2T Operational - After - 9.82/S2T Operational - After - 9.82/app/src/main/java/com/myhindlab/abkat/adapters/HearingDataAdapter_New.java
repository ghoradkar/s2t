...
public class HearingDataAdapter_New extends RecyclerView.Adapter<HearingDataAdapter_New.MyViewHolder> {

    private ArrayList<HearingData_New> hearingRecordList;

    public HearingDataAdapter_New(ArrayList<HearingData_New> hearingRecordList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        HearingData_New data = new HearingData_New();
