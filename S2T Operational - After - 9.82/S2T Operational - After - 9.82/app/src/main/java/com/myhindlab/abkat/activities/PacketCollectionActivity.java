...
public class PacketCollectionActivity extends AppCompatActivity {
...
//    private androidx.appcompat.widget.SearchView ;
    ...
    PacketCollectionAdapterNew packetCollectionAdapterNew;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_packet_collection);
    ...
    private void initView() {
        context = PacketCollectionActivity.this;
...
//        tv_to_date.setText(mdformat.format(calendar.getTime()));
    ...
    private void setUpToolbar() {
        ...
        getSupportActionBar().setTitle("Packet Collection");
...
//                }
                ...
                if (tv_lab.getText().toString().trim().isEmpty()) {
                    Utilities.showAlertDialog(context, "Alert", "Please select landing lab first then scan barcode", false);
                    return;
                }
        ...
        imv_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tv_lab.getText().toString().isEmpty()){
                    Utilities.showAlertDialog(context, "Alert", "Please select landing lab", false);
                    return;
                }
...
//                    c.add(Calendar.DAY_OF_MONTH, 14);
    ...
    private class GetPostCampDetails extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            res = WebServiceCall.APICall(ApplicationConstants.GetPacketCollectionData, ApplicationConstants.webservice_d2d, param);
            return res;
        }
                ...
                if (!result.equals("")) {
                    ...
                    if (status.equalsIgnoreCase("success")) {
                        ...
                        if (campBeneficiaryList.size() > 0) {
                            ...
                            packetCollectionAdapterNew = new PacketCollectionAdapterNew(context, campBeneficiaryList, "0", "0");
                            rv_patient_list.setAdapter(packetCollectionAdapterNew);
                        }
                    } else {
                        Utilities.showMessageString("Data Not Found", context);

                        packetCollectionAdapterNew = new PacketCollectionAdapterNew(context, new ArrayList<>(), "0", "0");
                        rv_patient_list.setAdapter(packetCollectionAdapterNew);
                    }
                }
            } catch (Exception e) {
                ...
                if (result != null && result.length() > 0 && !result.equalsIgnoreCase("[]")) {
                    ...
                    if (status.equalsIgnoreCase("Success")) {
                        ...
                        for (PacketCollectModel.Output t :
                            ...
                            if (t.isChecked()) {
                                JsonObject jsonObject = new JsonObject();
                                jsonObject.addProperty("Packet No :", t.getPacketNumber());
...
//                        for (PacketCollectModel.Output output :
//                                campBeneficiaryList) {
//
//                            if (output.isChecked()){
//
...
//                        }
                        ...
                        builder.setMessage(packetSelect + " " + "Packets Picked For Lab Transfer");
            ...
            try {
                ...
                if (result != null && result.length() > 0 && !result.equalsIgnoreCase("[]")) {
                    ...
                    if (status.equalsIgnoreCase("Success")) {
                        ...
                        builder.setTitle("Success");
                        builder.setCancelable(false);
                        builder.setMessage("Packet No :" + " " + edt_barcode1.getText().toString().trim() + " " + "Picked For Lab Transfer");
                        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                // finish();
