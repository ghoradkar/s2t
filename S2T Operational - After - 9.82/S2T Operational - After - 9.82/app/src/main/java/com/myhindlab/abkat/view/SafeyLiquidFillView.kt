...
public class SafeyLiquidFillView @JvmOverloads constructor(
        context: Context,
...
*/
    ...
    companion object {
        ...
        private val DEFAULT_WAVE_SHAPE = WaveViewLoading.ShapeType.ROUNDRECT.ordinal
        private val DEFAULT_TRIANGLE_DIRECTION = WaveViewLoading.TriangleDirection.NORTH.ordinal
    ...
    init {
        ...
        mShape =
                Shape.fromValue(attributes.getInt(R.styleable.SafeyLiquidFillView_shapeTypeSafey, 1))
        mShapePadding =
        ...
        mTopTitlePaint.textSize =
                attributes.getDimension(R.styleable.SafeyLiquidFillView_titleTopSize, sp2px(
        ...
        mTopTitleStrokePaint.strokeWidth =
                attributes.getDimension(R.styleable.SafeyLiquidFillView_titleTopStrokeWidth, dp2px(
        ...
        mCenterTitlePaint.textSize =
                attributes.getDimension(R.styleable.SafeyLiquidFillView_titleCenterSize, sp2px(
        ...
        mBottomTitlePaint.textSize =
                attributes.getDimension(R.styleable.SafeyLiquidFillView_titleBottomSize, sp2px(
        ...
        mBottomTitleStrokePaint.strokeWidth =
                attributes.getDimension(R.styleable.SafeyLiquidFillView_titleBottomStrokeWidth, dp2px(
                        DEFAULT_TITLE_STROKE_WIDTH
                ).toFloat())
