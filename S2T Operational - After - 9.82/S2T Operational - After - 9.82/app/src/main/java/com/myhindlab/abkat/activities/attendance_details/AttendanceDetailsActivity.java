...
public class AttendanceDetailsActivity extends AppCompatActivity implements InvoiceAdapter.onTouchListner {
    ActivityAttendanceDetailsBinding binding;
    private UserSessionManager sessionManager;

    private Bitmap patientPicBm = null, ackPicBm = null,campBitMap = null;
    ...
    private String isImageApproved = "0";
...
//        }
    ...
    void init() {
        mContext = AttendanceDetailsActivity.this;
...
//            getTestCompleteFlag();
    ...
    private void warningDialogue() {
        Dialog dialog;
        dialog = new Dialog(AttendanceDetailsActivity.this);
...
//                    Utilities.showAlertDialog(mContext,"Alert","Camp tests of few beneficiaries are pending.",false);
//                    return;
//                }

                Intent cameraIntent = new Intent(mContext, CameraActivity.class);
                cameraIntent.putExtra("CAPTURE_MODE", CaptureMode.GROUP_PHOTO.name());
...
//                }
        ...
        binding.tvCampImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                }
                ...
                Intent cameraIntent = new Intent(mContext, CameraActivity.class);
                cameraIntent.putExtra("CAPTURE_MODE", CaptureMode.GROUP_PHOTO.name());
                cameraLauncherForCampImage.launch(cameraIntent);
...
//                );
        ...
        binding.btnSaveCampClosingConfirmation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isImageApproved.equals("0")){
                    Utilities.showAlertDialog(mContext,"Alert","सर्व फोटो approve झाल्याशिवाय कॅम्प क्लोसिंग confirmation देता येणार नाही याची नोंद घ्यावी",false);
                    return;
                }
        ...
        binding.rbRegular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                binding.rbD2d.setTextColor(ContextCompat.getColor(AttendanceDetailsActivity.this, R.color.white));
        ...
        binding.rbD2d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                binding.rbRegular.setTextColor(ContextCompat.getColor(AttendanceDetailsActivity.this, R.color.white));
...
//        binding.btnSaveCampClosingConfirmation.setEnabled(false);
        ...
        AttendanceDetailsAdapter attendanceDetailsAdapter = new AttendanceDetailsAdapter(AttendanceDetailsActivity.this, new ArrayList<>());
        ...
        if (!(DESGID.equals("29") || DESGID.equals("162") || DESGID.equals("92")||DESGID.equals("139")||DESGID.equals("136"))) {
            ...
            binding.tvCampImage.setVisibility(View.VISIBLE);
            ...
            binding.llMainBtn.setVisibility(View.GONE);
            binding.tvCheckIn.setVisibility(View.GONE);
            binding.tvCampImage.setVisibility(View.GONE);
            binding.tvCheckOut.setVisibility(View.GONE);
        ...
        binding.tvUploadedCampImage.setText("");
...
//        insertData();
    ...
    private void showDatePicker(int dateTypeId) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(AttendanceDetailsActivity.this,
    ...
    private void getAttendanceDetails() {
        final ProgressDialog progressDialog = new ProgressDialog(AttendanceDetailsActivity.this);
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (status.equalsIgnoreCase("Success")) {
                            ...
                            binding.tvCheckIn.setEnabled(true);

//                            binding.tvCampImage.setEnabled(true);
//                            binding.tvCheckOut.setEnabled(true);
                            ...
                            AttendanceDetailsAdapter attendanceDetailsAdapter = new AttendanceDetailsAdapter(AttendanceDetailsActivity.this, attandanceDeatilsList);
                            binding.rvPatientList.setAdapter(attendanceDetailsAdapter);
...
//                            }
                            ...
                            if (pendingInCount >= 1) {
                                ...
                                binding.tvCheckIn.setEnabled(false);
                                binding.tvCheckOut.setEnabled(false);
                                binding.tvCampImage.setEnabled(false);
                                return;
                            } else {
                                isMarkInOut = "1";
...
//                                }
                                ...
                                if (inPhotoPath != null && !inPhotoPath.equals("NA")) {
                                    ...
                                    String baseUrl = BuildConfig.domain + "/CampTeamAttendance/" + inPhotoPath;

                                    // Add cache-busting param
                                    String url = baseUrl + "?t=" + System.currentTimeMillis();

                                    // Clear old cache
                                    Picasso.with(mContext).invalidate(baseUrl);
                                    ...
                                    binding.imvCheckIn.setOnClickListener(view -> {
...
//                                }
                                ...
                                if (campPhotoPath != null && !campPhotoPath.equals("NA")) {
                                    ...
                                    String urlCamp = BuildConfig.domain + "/CampTeamAttendance/" + campPhotoPath + "?t=" + System.currentTimeMillis();

                                    Picasso.with(mContext)
                                            .load(urlCamp)
                                            .into(binding.imvCampImage);

                                    binding.imvCampImage.setOnClickListener(view -> {
                                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(urlCamp)));
                                    });
                                }
...
//                                    binding.tvCampImage.setEnabled(true);
                                ...
                                if (output.getIsOutImageApproved().equals("Approved")){
                                    binding.tvCheckOut.setVisibility(View.GONE);
                                }
                                ...
                                if (!campPhotoPath.equals("NA") ) {
                                    binding.tvUploadedCampImage.setText("Uploaded On :" + output.getCampImagesUploadedOn());
                                    binding.tvUploadedCampImage.setVisibility(View.VISIBLE);
                                }


                                if (output.getIsDuringImageApproved().equals("Approved")){
                                    binding.tvCampImage.setVisibility(View.GONE);
                                }
                                ...
                                switch (output.getIsDuringImageApproved()) {
                                    case "Pending" -> binding.tvCampPhotoStatus.setVisibility(View.GONE);
                                    case "Approved" -> {
                                ...
                                switch (output.getIsOutImageApproved()) {
                                    case "Pending" -> binding.tvOutPhotoStatus.setVisibility(View.GONE);
                                    case "Approved" -> {
                                ...
                                if (!"NA".equals(inPhotoPath) && !"NA".equals(outImagePath) && !"NA".equals(campPhotoPath) ) {
                                    binding.llMainBtnUpload.setVisibility(View.GONE);
...
//                            Utilities.showAlertDialog(mContext, "Alert", "Data Not Found", false);
    ...
    private void showTrenchListDialog(final List<YearModel.Output> trenchList) {
        ...
        AlertDialog.Builder builderSingle = new AlertDialog.Builder(AttendanceDetailsActivity.this);
        builderSingle.setTitle("Select Year");
        builderSingle.setCancelable(false);
        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(AttendanceDetailsActivity.this, R.layout.list_row);
...
//                }
    ...
    ActivityResultLauncher<Intent> cameraLauncherForCampImage =
            registerForActivityResult(
                    new ActivityResultContracts.StartActivityForResult(),
                    result -> {
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            ...
                            try {
                                ...
                                String filename = (int) (Math.random() * 99999 + 1) + "_CI";
                                String compressedFilePath = Utilities.compressImageNew(mContext, fileURI, filename);
                                saveFileCI(compressedFilePath);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
    ...
    public void saveFileAI(String filePath) {
        ...
        insertDataNew(patientImagePath,"1");
    ...
    @SuppressLint("MissingPermission")
    public void saveFileCI(String filePath) {

        String destinationFilename = filePath;
        campBitMap = BitmapFactory.decodeFile(destinationFilename);
        String fName = System.currentTimeMillis() + "_CI.jpg";
        String outputFilePath = getExternalCacheDir() + fName;
        // Step 2: Compress the Bitmap and store it in a new file
        try {
            // Open a file output stream to save the compressed image
            ...
            // Compress the bitmap as JPEG with 80% quality
            campBitMap.compress(Bitmap.CompressFormat.JPEG, 80, fos);
        ...
        binding.imvCampImage.setImageBitmap(patientPicBm);
        campImagePath = outputFilePath;

//        binding.btnSave.setText("Upload Check In Image");

        insertDataNew(campImagePath,"3");
...
//        });
//    }
    private void insertDataNew(String patientImagePath, String status) {

        pd.setMessage("Uploading File..");
        pd.setCancelable(false);
        pd.show();

        File uploadFile = new File(patientImagePath);

        // ✅ File validation
        if (!uploadFile.exists() || uploadFile.length() == 0) {
            pd.dismiss();
            Log.e(TAG, "Invalid file: " + patientImagePath);
        ...
        // ✅ File Part (IMPORTANT: match API name)
        ...
        // ✅ Other params
        MultipartBody.Part campIdPart =
                MultipartBody.Part.createFormData("CampID", campId);

        MultipartBody.Part userIdPart =
                MultipartBody.Part.createFormData("UserId", EmpCode);

        MultipartBody.Part statusPart =
                MultipartBody.Part.createFormData("StatusID", status); // 👈 dynamic

        // 🚀 API Call
        apiInterface.insertAttendanceNew(
                campIdPart,
                filePart,
                userIdPart,
                statusPart
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if ("Success".equalsIgnoreCase(resStatus)) {
                        ...
                        switch (status) {
                            case "1":
                                successMessage = "चेक इन फोटो यशस्वीरीत्या अपलोड झाला आहे. तुमच्या manager च्या approval नंतर तुम्ही कॅम्प सुरु करू शकतात.";
                                break;

                            case "2":
                                successMessage = "चेक आउट फोटो यशस्वीरीत्या अपलोड झाला आहे. तुमच्या manager च्या approval नंतर तुम्ही कॅम्प closing confirmation देऊ शकतात.";
                                break;

                            case "3":
                                successMessage = "Camp सुरु असतानाचा beneficiary सोबतचा फोटो यशस्वीरीत्या अपलोड झाला आहे.";
                                break;

                            default:
                                successMessage = "टीमचा फोटो यशस्वीरित्या अपलोड झाला आहे.";
                                break;
                        }
                        ...
                        Utilities.showAlertDialog(
                                ...
                                true,
                                "Okay",
                                (dialog, which) -> getAttendanceDetails()
                        );
