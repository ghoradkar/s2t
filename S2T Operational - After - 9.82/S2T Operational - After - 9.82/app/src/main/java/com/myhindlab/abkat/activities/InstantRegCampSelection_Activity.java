...
public class InstantRegCampSelection_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instantreg_campselection);
    ...
    private void init() {
        context = InstantRegCampSelection_Activity.this;
        ...
        recyclerview_campList.addOnItemTouchListener(
                new RecyclerItemClickListener(context,
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, final int position) {
                                GetApprovedCampListDetailsForAppList campDetails = campList.get(position);
                                campDetails = campList.get(position);

                                startActivity(new Intent(context, InstantRegistration_Activity.class)
                                        .putExtra("SiteDetailId", campDetails.getSiteDetailId()));
                            }
                        }));
