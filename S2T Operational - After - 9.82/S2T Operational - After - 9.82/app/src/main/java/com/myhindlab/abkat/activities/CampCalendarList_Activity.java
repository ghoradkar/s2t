...
public class CampCalendarList_Activity extends AppCompatActivity {
    ...
    private String DESGID, DISTLGDCODE,organizationId="0",divisionId = "0",clusterWiseFlag="1", district, TALLGDCODE,empcode, taluka;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_campcalendar_list);
    ...
    private void init() {
        context = CampCalendarList_Activity.this;
...
//                        openExcel(fileUri.getPath());
    ...
    private void setDefaults() {
        ...
        if (getIntent() != null) {
            ...
            clusterWiseFlag = getIntent().getStringExtra("clusterId");
                    ...
                    if (Utilities.isNetworkAvailable(context)) {
                        ...
                        if (clusterWiseFlag!=null){
                            if (clusterWiseFlag.equalsIgnoreCase("1")){
                                new GetMonthlySurveySiteRequestForOS().execute(String.valueOf(selectedMonthId), String.valueOf(selectedYearId), DISTLGDCODE, String.valueOf(campTypeId),organizationId,divisionId,empcode,DESGID);

                            }else if (clusterWiseFlag.equalsIgnoreCase("2")){
                                new GetMonthlySurveySiteRequestForOSForCluster().execute(String.valueOf(selectedMonthId), String.valueOf(selectedYearId), DISTLGDCODE, String.valueOf(campTypeId),organizationId,divisionId,empcode,DESGID);
...
//            res = WebServiceCall.APICall(ApplicationConstants.GetMonthlySurveySiteRequestForOS, ApplicationConstants.webservice, param);
            res = WebServiceCall.APICall(ApplicationConstants.GetMonthlySurveySiteRequestForOS_Org, ApplicationConstants.webservice_d2d, param);
            return res;
        }
...
//                            rv_campList.setAdapter(new CampCalendarListAdapter(context, campList));
    ...
    private class GetMonthlySurveySiteRequestForOSForCluster extends AsyncTask<String, Void, String> {
...
//            res = WebServiceCall.APICall(ApplicationConstants.GetMonthlySurveySiteRequestForOS, ApplicationConstants.webservice, param);
            res = WebServiceCall.APICall(ApplicationConstants.GetMonthlySurveySiteRequestForOS_Org_Cluster, ApplicationConstants.webservice_d2d, param);
            return res;
        }
...
//            btnExport.setVisibility(View.GONE);
            ...
            try {
                ...
                for (int i = 0; i < filteredCampList.size(); i++) {
                    ...
                    sheet.addCell(new Label(0, pos, filteredCampList.get(i).getCampId()));
                    sheet.addCell(new Label(1, pos, String.valueOf(filteredCampList.get(i).getDISTNAME())));
                    sheet.addCell(new Label(2, pos, String.valueOf(filteredCampList.get(i).getCampDate())));
                    sheet.addCell(new Label(3, pos, String.valueOf(filteredCampList.get(i).getREGISTERWORKERS())));
                    sheet.addCell(new Label(4, pos, String.valueOf(filteredCampList.get(i).getCampStatus())));
