...
public class CSCCampRequestListAdapter extends RecyclerView.Adapter<CSCCampRequestListAdapter.CampRequestVH> {
    ...
    public CSCCampRequestListAdapter(Context context, List<CSCPreCampInfoForApprovalModel.Output> cscPreCampInfoForApprovalModelList, UpdateCamp updateCamp) {
    ...
    public CampRequestVH onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.camp_request_list_item, parent, false);
    ...
    public void onBindViewHolder(CampRequestVH holder, int position) {
        ...
        if (output.getDivMngrApproval() == 1) {
        ...
        } else if (output.getDivMngrApproval() == 2) {
        ...
        if (output.getDivMngrApproval() != 0) {
        ...
        holder.btnApprove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                isRejected = false;
                Utilities.showAlertDialog(context, "Confirmation", "Do you want to approve camp request?", true,
                        "Approve Camp", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
//                                new CSCCampApprovalUpdate(output, isRejected, "").execute();
//                                new InsertDivisionalManagerCampRequestApproval(output, isRejected, "").execute();
        ...
        holder.btnReject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(context);
                LayoutInflater layoutInflater = LayoutInflater.from(context);
                View promptView = layoutInflater.inflate(R.layout.dialog_with_edittext, null);
                builder.setView(promptView);
                builder.setCancelable(false);
                AlertDialog dialog = builder.create();
                TextInputEditText textInputEditText = promptView.findViewById(R.id.edtReason);
                TextInputLayout textInputLayout = promptView.findViewById(R.id.textInputLayout);

                AppCompatButton btnSubmit = promptView.findViewById(R.id.btnSubmit);
                AppCompatButton btnCancel = promptView.findViewById(R.id.btnCancel);
                ...
                btnSubmit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (!textInputEditText.getText().toString().trim().isEmpty()) {
                            ...
                            new InsertDivisionalManagerCampRequestApproval(output, isRejected, textInputEditText.getText().toString().trim()).execute();
//                            new CSCCampApprovalUpdate(output, isRejected, textInputEditText.getText().toString().trim()).execute();
...
//                                        updateCamp.onUpdateCamp();
    ...
    private class InsertDivisionalManagerCampRequestApproval extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            List<ParamsPojo> paramsPojos = new ArrayList<>();
            paramsPojos.add(new ParamsPojo("CSCPreAprrovedid", String.valueOf(output.getCSCPreAprrovedid())));
            paramsPojos.add(new ParamsPojo("DivMngrID", userId));
            paramsPojos.add(new ParamsPojo("DivMngrApproval", isRejected ? "2" : "1"));
            paramsPojos.add(new ParamsPojo("Reason", reason));
