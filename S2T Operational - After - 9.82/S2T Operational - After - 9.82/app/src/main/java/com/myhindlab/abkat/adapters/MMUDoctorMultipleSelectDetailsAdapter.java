...
public class MMUDoctorMultipleSelectDetailsAdapter extends RecyclerView.Adapter<MMUDoctorMultipleSelectDetailsAdapter.MyViewHolder> {

    private final ArrayList<MMUDoctorDetailsModel.OutputBean> doctorlist;

    public MMUDoctorMultipleSelectDetailsAdapter(ArrayList<MMUDoctorDetailsModel.OutputBean> doctorlist) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        MMUDoctorDetailsModel.OutputBean data = doctorlist.get(position);
