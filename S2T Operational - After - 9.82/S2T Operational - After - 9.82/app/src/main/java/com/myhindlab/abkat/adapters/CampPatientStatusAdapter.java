...
public class CampPatientStatusAdapter extends RecyclerView.Adapter<CampPatientStatusAdapter.MyViewHolder> {

    private List<PatientStatusModel> resultArrayList;
    private Context context;

    public CampPatientStatusAdapter(Context context, List<PatientStatusModel> resultArrayList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int pos) {
        ...
        if (patientStatus.getIsApproved()!=null) {
            if (patientStatus.getIsApproved().equalsIgnoreCase("2")) {
                holder.mainll.setBackgroundColor(context.getResources().getColor(R.color.redLight));
            } else if (patientStatus.getIsApproved().equalsIgnoreCase("1")) {
                holder.mainll.setBackgroundColor(context.getResources().getColor(R.color.light_green));
            }
        }
