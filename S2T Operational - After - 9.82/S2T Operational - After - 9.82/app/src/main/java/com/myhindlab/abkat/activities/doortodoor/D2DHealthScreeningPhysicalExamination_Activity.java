...
public class D2DHealthScreeningPhysicalExamination_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private MaterialEditText edt_cancer_history, edt_lumb_observed, edt_personal_observation, edt_comment, edt_final_remark;
    ...
    String lungComment, abnormalComment, cvsComment, GITComment, skinInfection, gynaComment, cnsComment, finalComment, jsonstring, dateString, distlgdcode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d2d_health_screening_physical_examination);
    ...
    private void init() {
        context = D2DHealthScreeningPhysicalExamination_Activity.this;
        ...
        if (SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            patientPicsFolder = new File(Environment.getExternalStorageDirectory() + "/MCWWB/" + "/Patient Photos/");
    ...
    private void setUpToolbar() {
        ...
        getSupportActionBar().setTitle("D2D Physical Examination");
                    ...
                    if (status.equalsIgnoreCase("Success")) {
                        if (gneder.equalsIgnoreCase("female")) {
                            ...
                            builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
//                                    startActivity(new Intent(context, D2DPrescriptionUpload_Activity.class)
//                                            .putExtra("siteId", patientDetails.getSiteId())
//                                            .putExtra("registrationNo", String.valueOf(regdId)));
