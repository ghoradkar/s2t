...
public class HealthScreeningAudioTest_Activity_New extends AppCompatActivity {

    private Context context;
    private ProgressDialog pd;
    private String TAG = getClass().getName();
    private UserSessionManager session;
    private MaterialEditText edt_beneficiaryname,edt_deficity, edt_gender, edt_age, edt_height, edt_weight;
    private PresentPatientList_Model patientDetails;
    private String userID, campId,versionName, hearingObservation = "", RightRemark = "", healthScreentype,data,deflicityId="";
    ...
    private boolean isButtonIsClicked = false;
    ...
    private void init() {
        context = HealthScreeningAudioTest_Activity_New.this;
        ...
        edt_deficity = findViewById(R.id.edt_deficity);
    }
...
//        }
        ...
        hearingData = new ArrayList<>();
            ...
            if (deflicityId.equalsIgnoreCase("1")) {
                for (int i = 0; i < hzFreq.size(); i++) {
                    hearingData.add(new HearingData_New(hzFreq.get(i).getValue(), 0, 40));
                }
            }  else {
                for (int i = 0; i < hzFreq.size(); i++) {
...
//        line_chart.setBackground(gradientDrawable);
    ...
    private void setEventHandler() {
        edt_deficity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ArrayList<CampTypeModel> campTypeModelArrayList = new ArrayList<>();
                campTypeModelArrayList.add(new CampTypeModel("Right Ear", 1));
                campTypeModelArrayList.add(new CampTypeModel("Left Ear", 2));
                campTypeModelArrayList.add(new CampTypeModel("Both Ears", 3));
                campTypeModelArrayList.add(new CampTypeModel("No Deafness", 4));
        ...
        edt_frequency.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (edt_deficity.getText().toString().trim().isEmpty()) {
                    Utilities.showToastMessage("Please Select Option In Deafness Info ", context, false);
                    return;
                }
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (deflicityId.equalsIgnoreCase("1")||deflicityId.equalsIgnoreCase("2")||deflicityId.equalsIgnoreCase("4")) {


                    if (!isButtonIsClicked) {
                        Utilities.showToastMessage("Please perform audiometric test", context, false);
                        return;
                    }
...
//                String obsver = hearingObservation;
                for (int i = 0; i < hearingData.size(); i++) {
                    hearingData.get(i).setPatientRegId(String.valueOf(patientDetails.getRegdId()));
                ...
                Gson gson = new Gson();
                data = gson.toJson(hearingData);

                Log.d("Audio JSON",data+" "+patientDetails.getRegdId()
                        +" "+userID);
        ...
        builderSingle.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (type.equals("3")) {
                    ...
                    if ((deflicityId.equalsIgnoreCase("2") || deflicityId.equalsIgnoreCase("4")) && RightRemark.equalsIgnoreCase("5")){
                        Utilities.showAlertDialog(context, "Alert", "This remark can only be selected if deafness is observed in any of the ear", false);
                        edt_observation.setText("");
                    }
                    ...
                    if ((deflicityId.equalsIgnoreCase("1") || deflicityId.equalsIgnoreCase("4")) && hearingObservation.equalsIgnoreCase("5")){
                        Utilities.showAlertDialog(context, "Alert", "This remark can only be selected if deafness is observed in any of the ear", false);
                        edt_leftobservation.setText("");
    ...
    private void showCampType(final ArrayList<CampTypeModel> campTypeModelsList) {
        ...
        builderSingle.setTitle("Select Deficit");
        builderSingle.setCancelable(false);
        ...
        builderSingle.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                edt_deficity.setText(campTypeModelsList.get(which).getCampTypeName());
                deflicityId = String.valueOf(campTypeModelsList.get(which).getCampTypeId());


                if (deflicityId.equalsIgnoreCase("1")||deflicityId.equalsIgnoreCase("2")||deflicityId.equalsIgnoreCase("3")){
...
//            alertDialog.show();
                        ...
                        android.app.AlertDialog.Builder b = new android.app.AlertDialog.Builder(context)
                                .setTitle("तुम्ही मूकबधिर पर्याय निवडला आहे. \n" +
                ...
                if (deflicityId.equalsIgnoreCase("1")){
                    ...
                    edt_volume.setEnabled(true);

                    edt_observation.setText("Deafness");
                    edt_observation.setEnabled(false);
                    RightRemark = "5";
                    edt_leftobservation.setEnabled(true);
                    ...
                    btn_addvolume.setEnabled(true);
                    btn_subvolume.setEnabled(true);
                ...
                }else if (deflicityId.equalsIgnoreCase("2")){
                    ...
                    hearingObservation = "5";
                    edt_leftobservation.setText("Deafness");

                    edt_observation.setEnabled(true);
                    edt_leftobservation.setEnabled(false);
                ...
                }else if (deflicityId.equalsIgnoreCase("3")){
                    rb_left.setEnabled(false);
                    rb_right.setEnabled(false);
                    ...
                    btn_addvolume.setEnabled(false);
                    btn_subvolume.setEnabled(false);
                    ...
                    rb_left.setChecked(false);
                    rb_right.setChecked(false);
                }else if (deflicityId.equalsIgnoreCase("4")){
                    rb_left.setEnabled(true);
                    rb_right.setEnabled(true);
                    edt_frequency.setEnabled(true);
                    edt_volume.setEnabled(true);
                ...
                for (int i = 0; i < hzFreq.size(); i++) {
                    if (deflicityId.equalsIgnoreCase("1")){
                        ...
                        hearingData.add(new HearingData_New(hzFreq.get(i).getValue(), 40, 0));
                    }else if (deflicityId.equalsIgnoreCase("3")){
                        hearingData.add(new HearingData_New(hzFreq.get(i).getValue(), 0, 0));
                    }else if (deflicityId.equalsIgnoreCase("4")){
                        hearingData.add(new HearingData_New(hzFreq.get(i).getValue(), 40, 40));
...
//        leftAxis.enableAxisLineDashedLine(1f,1f,0f);
...
//            }
        ...
        LineDataSet set = new LineDataSet(yVals, "Left");
        set.enableDashedLine(5f,3f,0f);
                ...
                if (surverCode == ApplicationConstants.OKSUCCESS) {
                    try {
                        ...
                        if (status.equalsIgnoreCase("Success")) {
                            new InsertAudioImagesOld().execute(
        ...
        protected String doInBackground(String... params) {
            ...
            if (BuildConfig.isBeta){
                ...
                try {
                    ...
                    MultipartUtility multipart = new MultipartUtility(ApplicationConstants.InsertAudioImages_version, "UTF-8");

                    Log.d("UploadAudioImg", Arrays.toString(params));
                    multipart.addFormField("RegId", params[0]);
                    multipart.addFormField("CreatedBy", params[1]);
                    multipart.addFormField("JsonString", params[2]);
                    multipart.addFilePart("", new File(params[3]));
                    multipart.addFormField("VersionNo", params[4]);
...
//                try {
//
//                    MultipartUtility multipart = new MultipartUtility(ApplicationConstants.InsertAudioImages_New, "UTF-8");
//
//                    Log.d("UploadAudioImg", Arrays.toString(params));
//                    multipart.addFormField("RegId", params[0]);
//                    multipart.addFormField("CreatedBy", params[1]);
...
//                }
        ...
        protected void onPostExecute(String result) {
            ...
            Log.d("UploadAudioImg resp", result);
...
//                        showReuploadDialog();
                    Utilities.showToastMessage("Please try again !", context, false);
...
//                }
                ...
                e.printStackTrace();
                Utilities.showToastMessage("File not generated, please take test again!", context, false);
...
//                showReuploadDialog();
    ...
    public class InsertAudioImagesOld extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                Log.d("UploadAudioImg Old", Arrays.toString(params));
                multipart.addFormField("RegId", params[0]);
                multipart.addFormField("CreatedBy", params[1]);
//                multipart.addFormField("JsonString", params[2]);
                multipart.addFilePart("", new File(params[2]));
        ...
        protected void onPostExecute(String result) {
            super.onPostExecute(result);
            Log.d("UploadAudioImgOld resp", result);
...
//                }
                ...
                e.printStackTrace();
                Utilities.showToastMessage("Unable to upload file, please try again!", context, false);
    ...
    private void createPdf(Bitmap bitmap) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.R){
                filePath = new File(getExternalCacheDir(), userID + "_" + patientDetails.getRegdId() + ".pdf");

            }else{
                filePath = new File(patientPicsFolder, userID + "_" + patientDetails.getRegdId() + ".pdf");
            }
            try {
...
//                    InsertMachineHearingTestAPICall(userID, data);
                    ...
                    Utilities.showAlertDialog(context,"Test Not Done","Do Audiometry Test",false);
                }
            } catch (IOException e) {
                e.printStackTrace();
