...
import com.myhindlab.abkat.camera.graphic.GraphicOverlay

class CameraAnalyzer(
    private val overlay: GraphicOverlay<*>,
    private val cameraAnalyzerEvent: CameraAnalyzerEvent
) : BaseCameraAnalyzer<List<Face>>() {

    interface CameraAnalyzerEvent {
        fun onImageAnalysis(faces: List<Face>)
    }
    ...
    override fun onSuccess(results: List<Face>, graphicOverlay: GraphicOverlay<*>, rect: Rect) {
        cameraAnalyzerEvent.onImageAnalysis(results)
