...
import com.myhindlab.abkat.adapters.doortodoor.ConfirmatoryTestTeamAssignAdapter;
...
public class ConfirmatoryTestAssignTeamActivity extends AppCompatActivity {
    ...
    private TextView tv_block, tv_from_date, tv_to_date, tv_total, tv_taluka, tv_filterremark,tvDate, tv_teamNumber, tvCamp, tvCampType, tv_District;
    ...
    ConfirmatoryTestTeamAssignAdapter confirmatoryTestTeamAssignAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirmatory_test_team_assign);
        initView();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void initView() {
        context = ConfirmatoryTestAssignTeamActivity.this;
...
//        new GetPostCampDetails().execute(fromDate, CampDateToDate, EmpCode, DISTLGDCODE, talukaId, searchview_campname_pincode.getText().toString(), "1");
    ...
    private void loadMoreData() {
        ...
        confirmatoryTestTeamAssignAdapter = new ConfirmatoryTestTeamAssignAdapter(context, filteredList);
...
//            public void afterTextChanged(Editable s) {
//                if (!searchview_campname_pincode.getText().toString().trim().equals("")) {
//                    confirmatoryTestTeamAssignAdapter = new ConfirmatoryTestTeamAssignAdapter(context, new ArrayList<>());
//                    rv_patient_list.setAdapter(confirmatoryTestTeamAssignAdapter);
//                    if (searchview_campname_pincode.getText().toString().trim().length() == 6) {
//
//
        ...
        searchview_campname.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (facilitySearchedList.size() == 0) {
                    ...
                    confirmatoryTestTeamAssignAdapter = new ConfirmatoryTestTeamAssignAdapter(context, facilitySearchedList);
                    rv_patient_list.setAdapter(confirmatoryTestTeamAssignAdapter);
...
//                    setRecyclerView(facilitySearchedList);
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (newText.equals("")) {
                    ...
                    confirmatoryTestTeamAssignAdapter = new ConfirmatoryTestTeamAssignAdapter(context, campBeneficiaryList);
                    rv_patient_list.setAdapter(confirmatoryTestTeamAssignAdapter);
...
//            res = WebServiceCall.APICall(ApplicationConstants.GetBeneficiaryDetailsforDistCoordinator, ApplicationConstants.webservice_d2d, param);
            res = WebServiceCall.APICall(ApplicationConstants.GetT2T_CT_BeneficiaryDetailsforDistCoordinator_V3, ApplicationConstants.webservice_d2d, param);
            return res;
        }
...
//    }
    ...
    protected void onResume() {
        ...
        if (searchview_campname_pincode.getText().toString().isEmpty()) {
            ...
            new GetPostCampDetails().execute(fromDate, CampDateToDate, EmpCode, DISTLGDCODE, talukaId, "0", Remark_Id);

        } else {

            new GetPostCampDetails().execute(fromDate, CampDateToDate, EmpCode, DISTLGDCODE, talukaId, searchview_campname_pincode.getText().toString(), Remark_Id);
        }
    }
}