...
public class CTMedicineDetailsAdapter extends RecyclerView.Adapter<CTMedicineDetailsAdapter.MyViewHolder> {

    private final List<TeamCallingModel.Output> teamList;
    private Context context;


    public CTMedicineDetailsAdapter(Context context, List<TeamCallingModel.Output> teamList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tvMemberName.setText(data.getMemberName());
