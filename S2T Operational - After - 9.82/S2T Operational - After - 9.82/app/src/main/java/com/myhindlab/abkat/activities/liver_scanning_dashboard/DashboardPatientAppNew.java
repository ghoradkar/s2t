...
import com.myhindlab.abkat.databinding.PatientAppDashboardNewBinding;
...
public class DashboardPatientAppNew extends AppCompatActivity {
    PatientAppDashboardNewBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = PatientAppDashboardNewBinding.inflate(getLayoutInflater());
    ...
    void init() {
        mContext = DashboardPatientAppNew.this;
...
//        getCount();
    ...
    private void eventListener() {
        ...
        binding.mainAndroidLl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(mContext, AndroidCount.class)
                        .putExtra("Type", "1"));

            }
        });
        binding.mainLlIOS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(mContext, AndroidCount.class)
                        .putExtra("Type", "2"));
    ...
    private void setUpToolbar() {
        ...
        getSupportActionBar().setTitle("S2T Patient App");
...
//        toolbar.setNavigationIcon(R.drawable.icon_arrowback);
//        imageButton.setNavigationOnClickListener(v -> finish());
    ...
    private void getCount() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(DashboardPatientAppNew.this);
