...
import com.myhindlab.abkat.bioland.MainApplication;
import com.qmuiteam.qmui.widget.dialog.QMUITipDialog;


/**
 * @author zhudewei 在系统的Toast基础上封装
 */
...
//        normal(MainApplication.getInstance(), message, Toast.LENGTH_SHORT, null, false).show();
//    }
//
...
//        normal(MainApplication.getInstance(), message, Toast.LENGTH_SHORT, icon, true).show();
//    }
//
//    public static void normal(@NonNull String message, int duration) {
//        normal(MainApplication.getInstance(), message, duration, null, false).show();
//    }
//
//    public static void normal(@NonNull String message, int duration, Drawable icon) {
//        normal(MainApplication.getInstance(), message, duration, icon, true).show();
//    }
//
//    public static Toast normal(@NonNull String message, int duration, Drawable icon, boolean withIcon) {
//        return custom(MainApplication.getInstance(), message, icon, DEFAULT_TEXT_COLOR, duration, withIcon);
//    }
//
//    public static void warning(@NonNull String message) {
//        warning(MainApplication.getInstance(), message, Toast.LENGTH_SHORT, true).show();
//    }
//
//    public static void warning(@NonNull String message, int duration) {
//        warning(MainApplication.getInstance(), message, duration, true).show();
//    }
//
//    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
//        return custom(MainApplication.getInstance(), message, getDrawable(getContext(), R.drawable.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
//    }
//
//    public static void info(@NonNull String message) {
//        info(MainApplication.getInstance(), message, Toast.LENGTH_SHORT, true).show();
//    }
//
//    public static void info(@NonNull String message, int duration) {
//        info(MainApplication.getInstance(), message, duration, true).show();
//    }
//
//    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
//        return custom(MainApplication.getInstance(), message, getDrawable(getContext(), R.drawable.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
//    }
//
//    public static void success(@NonNull String message) {
//        success(MainApplication.getInstance(), message, Toast.LENGTH_SHORT, true).show();
//    }
//
//    public static void success(@NonNull String message, int duration) {
//        success(MainApplication.getInstance(), message, duration, true).show();
//    }
//
//    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
//        return custom(MainApplication.getInstance(), message, getDrawable(getContext(), R.drawable.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
//    }
//
//    public static void error(@NonNull String message) {
//        error(MainApplication.getInstance(), message, Toast.LENGTH_SHORT, true).show();
//    }
...
//        error(MainApplication.getInstance(), message, duration, true).show();
//    }
//
//    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
//        return custom(MainApplication.getInstance(), message, getDrawable(getContext(), R.drawable.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
//    }
//
//    @CheckResult
...
//            ZToast.normal(ZUiUtils.getString(R.string.Press_again_will_exit));
