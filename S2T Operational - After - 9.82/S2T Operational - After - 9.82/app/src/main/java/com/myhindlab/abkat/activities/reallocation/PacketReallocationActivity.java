package com.myhindlab.abkat.activities.reallocation;
...
import com.myhindlab.abkat.activities.PacketAssignmentActivity;
...
public class PacketReallocationActivity extends AppCompatActivity {
...
//    private androidx.appcompat.widget.SearchView ;
    ...
    PackageAssignmentAdapterNew postCampBeneficiaryAdapter;

    private ArrayList<DistrictList_Model> districtList;

    private ArrayList<PacketAcceptModel.Output> filteredList = new ArrayList<>();
    ...
    private String campId = "0", callType, landinglabId = "0", talukaId = "0", resourceId, isAdmin, UserId, campTypeId, EmpCode, STATELGDCODE = "2", DESGID, teamId = "0",
...
//        }
        ...
        setContentView(R.layout.activity_packet_reallocation);
    ...
    private void initView() {
        context = PacketReallocationActivity.this;
...
//        toolbar.setNavigationOnClickListener(v -> finish());
        ...
        btn_registration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog dialog;
                dialog = new Dialog(PacketReallocationActivity.this);
...
// Set the text, size, color, and other properties
        titleTextView.setText("Packet Allocation & Re-Allocation ");
...
//            llDistrict.setVisibility(View.GONE);
            ...
            LL_delivery_executive.setVisibility(View.GONE);
...
//
//                    postCampBeneficiaryAdapter = new PackageAssignmentAdapterNew(context, facilitySearchedList, "0", "0");
...
//                    facilitySearchedList.clear();
//
//                    postCampBeneficiaryAdapter = new PackageAssignmentAdapterNew(context, campBeneficiaryList, "0", "0");
//                    rv_patient_list.setAdapter(postCampBeneficiaryAdapter);
//
...
//        });
        ...
        cb_accept.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                ...
                for (PacketAcceptModel.Output output : filteredList) {
...
// Search View Logic
        searchview_campname.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            private void filterList(String query) {
                ...
                postCampBeneficiaryAdapter = new PackageAssignmentAdapterNew(context, filteredList, "0", "0");
                rv_patient_list.setAdapter(postCampBeneficiaryAdapter);
            ...
            private boolean isAllSelected(List<PacketAcceptModel.Output> list) {
                for (PacketAcceptModel.Output output : list) {
...
//                llDistrict.setVisibility(View.GONE);
                ...
                mainLL_search.setVisibility(View.VISIBLE);
                mainLL_searchView.setVisibility(View.GONE);
                ...
                if (Utilities.isNetworkAvailable(context)) {
                    ...
                    new GetBarcodePostCampDetails().execute("", "", "0", talukaId,
        ...
        rb_manual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                btn_accept_courier.setText("Packet Assign");
            ...
            try {
                if (!result.equals("")) {
                    ...
                    if (status.equalsIgnoreCase("success")) {
                        ...
                        postCampBeneficiaryAdapter = new PackageAssignmentAdapterNew(context, new ArrayList<>(), "0", "0");
                        rv_patient_list.setAdapter(postCampBeneficiaryAdapter);
                    }
                }
            } catch (Exception e) {
        ...
        if (campBeneficiaryList != null) {
            ...
            for (PacketAcceptModel.Output t :
                ...
                if (t.isChecked()) {
                    ...
                    jsonObject.addProperty("DISTLGDCODE", DISTLGDCODE);
                    jsonObject.addProperty("TALLGDCODE", talukaId);
                    jsonObject.addProperty("Labcode", t.getLabcode());
                    jsonObject.addProperty("PacketID", t.getPacketNumber());
                    jsonObject.addProperty("TreatmentID", t.getPrescriptionID());
                    jsonObject.addProperty("OverallStatusID", t.getOverallStatusID());
...
//
    ...
    private class InsertAssignPacketDetails extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            param.add(new ParamsPojo("DeliveryExecutiveID", params[2]));
//            res = WebServiceCall.APICall(ApplicationConstants.InsertPacketAssignDetailsManually, ApplicationConstants.webservice_d2d, param);
            res = WebServiceCall.APICall(ApplicationConstants.InsertPacketAssignDetailsManually_D2DTeam, ApplicationConstants.webservice_d2d, param);
            return res;
        }
            ...
            try {
                ...
                if (result != null && result.length() > 0 && !result.equalsIgnoreCase("[]")) {
                    ...
                    if (status.equalsIgnoreCase("Success")) {
                        ...
                        builder.setMessage("Packet Assigned successfully");
    ...
    private class InsertPacketDetails extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            Log.d("InsertPacket", "doInBackground: " + Arrays.toString(params));
            List<ParamsPojo> param = new ArrayList<ParamsPojo>();
            param.add(new ParamsPojo("CW_ReallocationMedicalDelivary", params[0]));
            param.add(new ParamsPojo("USERID", params[1]));
            res = WebServiceCall.APICall(ApplicationConstants.UpdateReallocationMedicalDelivary, ApplicationConstants.webservice_d2d, param);
            return res;
        }
...
//            }
    ...
    private class GetBarcodePostCampDetails extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            param.add(new ParamsPojo("Labcode", params[2]));
            param.add(new ParamsPojo("TALLGDCODE", params[3]));
            param.add(new ParamsPojo("PacketID", params[4]));


            Log.d("GetPostCampDetails", "doInBackground: " + new Gson().toJson(param));

            res = WebServiceCall.APICall(ApplicationConstants.GetPatientListReAllocationforMedicineDeliveryByPacketID, ApplicationConstants.webservice_d2d, param);
            return res;
        }
