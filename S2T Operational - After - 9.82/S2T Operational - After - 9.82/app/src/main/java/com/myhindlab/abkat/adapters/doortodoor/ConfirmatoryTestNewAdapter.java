...
import com.myhindlab.abkat.activities.confirmatoryTest.AppointmentConfirmationConfirmatoryNewActivity;
import com.myhindlab.abkat.models.doortodoor.TeamCallingModel;

import java.util.List;

public class ConfirmatoryTestNewAdapter extends RecyclerView.Adapter<ConfirmatoryTestNewAdapter.MyViewHolder> {
    ...
    public ConfirmatoryTestNewAdapter(Context context, List<TeamCallingModel.Output> teamList,String distLgDCode) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_confirmatory_test_new, parent, false);
      ...
      //  holder.tvWorkingTeamNew.setText(String.valueOf(data.getWorkingTeamCount()));
        ...
        holder.tvMemberName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, AppointmentConfirmationConfirmatoryNewActivity.class)
