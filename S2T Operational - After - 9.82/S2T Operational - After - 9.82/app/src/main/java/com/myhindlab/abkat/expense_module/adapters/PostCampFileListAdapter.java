...
public class PostCampFileListAdapter extends RecyclerView.Adapter<PostCampFileListAdapter.PostCampFileViewHolder> {
    private ArrayList<PostCampFileListModel> postCampFileListModels;
    private PostCampFileListEvents postCampFileListEvents;

    public interface PostCampFileListEvents {
        void onDelete(PostCampFileListModel postCampFileListModel, int pos);
    }

    public PostCampFileListAdapter(ArrayList<PostCampFileListModel> postCampFileListModels, PostCampFileListEvents postCampFileListEvents) {
        this.postCampFileListModels = postCampFileListModels;
        this.postCampFileListEvents = postCampFileListEvents;
    }
    ...
    public void onBindViewHolder(@NonNull PostCampFileViewHolder holder, int position) {
        PostCampFileListModel postCampFile = postCampFileListModels.get(holder.getAbsoluteAdapterPosition());
            ...
            public void onClick(View v) {
                ...
                alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        postCampFileListEvents.onDelete(postCampFile, holder.getAbsoluteAdapterPosition());
                        notifyItemRemoved(holder.getAbsoluteAdapterPosition());
                        notifyItemRangeChanged(holder.getAbsoluteAdapterPosition(), postCampFileListModels.size());
                        dialog.dismiss();
                    }
                });
    ...
    public int getItemCount() {
        return postCampFileListModels.size();
    }
