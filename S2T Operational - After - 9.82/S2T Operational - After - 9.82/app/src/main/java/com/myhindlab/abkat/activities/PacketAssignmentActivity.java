...
public class PacketAssignmentActivity extends AppCompatActivity {
...
//    private androidx.appcompat.widget.SearchView ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_packet_assignment);
    ...
    private void initView() {
        context = PacketAssignmentActivity.this;
...
//                }
        ...
        btn_accept_courier.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog dialog;
                dialog = new Dialog(PacketAssignmentActivity.this);
