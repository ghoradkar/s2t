...
public class InvoiceForDoctorAdapter extends RecyclerView.Adapter<InvoiceForDoctorAdapter.myview> {
    ...
    public InvoiceForDoctorAdapter(Context context, List<InvoiceGenModel.Output> invoiceList, onTouchListner onTouchListner) {
...
//        holder.tv_inVoice.setText(""+item.getTotalIndividualBillable());
        ...
        if (item.getInvoiceStatus().equalsIgnoreCase("Pending")) {
            ...
            holder.tv_inVoice.setText("Raised");
