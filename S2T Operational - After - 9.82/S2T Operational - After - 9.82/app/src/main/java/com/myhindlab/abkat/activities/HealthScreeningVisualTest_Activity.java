...
import com.myhindlab.abkat.models.RemidioModel_V1;
...
public class HealthScreeningVisualTest_Activity extends AppCompatActivity {

    private Context context;
    private UserSessionManager session;
    private ProgressDialog pd;
    private MaterialEditText edt_beneficiaryname,edt_jaegar_chart_right,edt_jaegar_chart_left, edt_gender, edt_age, edt_injury_right, edt_injury_left, edt_eyecolor_right, edt_eyecolor_left,
            edt_remark, edt_right_remark, edt_left_remark,edt_leftSnellen_remark, edt_snellen_right,edt_rightSnellen_remark, edt_snellen_left, edt_jaegar_chart, edt_height, edt_weight, edt_near_remark;
    ...
    private String userID, name,versionName, campId, rigthEyeColorId = "0", leftEyeColorId = "0", rigthDiseaseId = "0", leftDiseaseId = "0",blindnessId = "0",
    ...
    private MaterialEditText edt_p1reported,edt_blindness, edt_p2reported, edt_p3reported, edt_p4reported, edt_p5reported, edt_p6reported, edt_p7reported, edt_p8reported, edt_p9reported, edt_p10reported, edt_p11reported, edt_p12reported,
    ...
    private RemidioModel_V1 remidioModel_v1;
    ...
    private void init() {
        context = HealthScreeningVisualTest_Activity.this;
        ...
        edt_blindness = findViewById(R.id.edt_blindness);
        edt_leftSnellen_remark = findViewById(R.id.edt_leftSnellen_remark);
        ...
        edt_rightSnellen_remark = findViewById(R.id.edt_rightSnellen_remark);
        ...
        edt_rightSnellen_remark.setEnabled(false);
        edt_leftSnellen_remark.setEnabled(false);
        edt_left_remark.setEnabled(false);
        edt_right_remark.setEnabled(false);
    ...
    private void setEventHandler() {
        ...
        edt_injury_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edt_blindness.getText().toString().trim().isEmpty()) {
                    edt_blindness.setError("Please select this field");
                    edt_blindness.requestFocus();
                    return;
                }
...
//                diseaseInjury.add(new MasterModel("6", "Cataract Operation"));
        ...
        edt_blindness.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ArrayList<MasterModel> blindness = new ArrayList<>();

                blindness.add(new MasterModel("1", "Right Eye"));
                blindness.add(new MasterModel("2", "Left Eye"));
                blindness.add(new MasterModel("3", "Both Eye"));
                blindness.add(new MasterModel("4", "Not Blind"));

                showBlindnessDialog(blindness, "1");
            }
        });
...
//                snellenList.add(new MasterModel("7", " 6/6"));
                ...
                snellenList.add(new MasterModel("1", " 6/6"));
                snellenList.add(new MasterModel("2", " 6/9"));
                snellenList.add(new MasterModel("3", " 6/12"));
                snellenList.add(new MasterModel("4", " 6/18"));
                snellenList.add(new MasterModel("5", " 6/24"));
                snellenList.add(new MasterModel("6", " 6/36"));
                snellenList.add(new MasterModel("7", " 6/60"));
        ...
        edt_jaegar_chart_right.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                }
        ...
        edt_jaegar_chart_left.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                }
                ...
                jaegarchartList.add(new MasterModel("5", "N12"));
                jaegarchartList.add(new MasterModel("6", "N18"));
                showJaegarChartListDialogLeft(jaegarchartList);
            }
        });
...
//                showSuggestionListDialog(suggestionList, "2");
        ...
        btnSubmitMachineData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (remidioModel_v1 != null) {
                    new InsertEyeScreeningMachineData().execute(new Gson().toJson(remidioModel_v1));
                }
...
//                builder.show();
    ...
    private void showBlindnessDialog(final ArrayList<MasterModel> pipeTypeList, final String type) {
        final AlertDialog.Builder builderSingle = new AlertDialog.Builder(context);
        if (type.equals("1")) {
            builderSingle.setTitle("Select Visual Impaired");
        } else if (type.equals("2")) {
            builderSingle.setTitle("Evidence of Disease or Injury Left Eye");
        }
        builderSingle.setCancelable(false);
        ...
        builderSingle.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (type.equals("1")) {
                    blindnessId = pipeTypeList.get(which).getId();
                    edt_blindness.setText(pipeTypeList.get(which).getName());
                } else if (type.equals("2")) {
                    leftDiseaseId = pipeTypeList.get(which).getId();
                    edt_injury_left.setText(pipeTypeList.get(which).getName());
                }
                ...
                if (blindnessId.equalsIgnoreCase("1")||blindnessId.equalsIgnoreCase("2")||blindnessId.equalsIgnoreCase("3")){
...
//            alertDialog.show();
                    ...
                    android.app.AlertDialog.Builder b = new android.app.AlertDialog.Builder(context)
                            .setTitle("तुम्ही अंध पर्याय निवडला आहे. \n" +
                            ...
                            .setNegativeButton("No",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int whichButton) {
                                            edt_blindness.setText("");
                                            blindnessId = "";
                                            showBlindnessDialog(pipeTypeList, "1");
                ...
                if (blindnessId.equalsIgnoreCase("1")){
                    edt_injury_right.setText("Right Eye Blind");
                    edt_rightSnellen_remark.setText("Right Eye Blind");

                    edt_right_remark.setText("Right Eye Blind");
                    edt_near_remark.setText("Right Eye Blind");



                    edt_injury_right.setEnabled(false);
                    rigthDiseaseId = "11";
                    edt_snellen_right.setText("NA");
                    edt_snellen_right.setEnabled(false);

                    edt_jaegar_chart_left.setEnabled(true);

                    edt_jaegar_chart_right.setText("NA");
                    edt_jaegar_chart_right.setEnabled(false);

                    edt_left_remark.setText("");
                    edt_left_remark.setText("");
                    edt_leftSnellen_remark.setText("");

                    edt_injury_left.setText("");
                    edt_injury_left.setEnabled(true);
                    leftDiseaseId = "";
                    edt_snellen_left.setText("");
                    edt_snellen_left.setEnabled(true);


                    edt_jaegar_chart_left.setText("");
                    edt_jaegar_chart_left.setEnabled(true);


                }else if (blindnessId.equalsIgnoreCase("2")){
                    edt_injury_left.setText("Left Eye Blind");
                    edt_left_remark.setText("Left Eye Blind");
                    edt_leftSnellen_remark.setText("Left Eye Blind");
                    edt_near_remark.setText("Left Eye Blind");

                    edt_injury_left.setEnabled(false);
                    leftDiseaseId = "11";
                    edt_snellen_left.setText("NA");
                    edt_snellen_left.setEnabled(false);
                    edt_jaegar_chart_left.setText("NA");
                    edt_jaegar_chart_left.setEnabled(false);
                    edt_right_remark.setText("");


                    edt_injury_right.setText("");
                    edt_injury_right.setEnabled(true);
                    rigthDiseaseId = "";
                    edt_snellen_right.setText("");
                    edt_snellen_right.setEnabled(true);
                    edt_rightSnellen_remark.setText("");

                    edt_jaegar_chart_right.setText("");
                    edt_jaegar_chart_right.setEnabled(true);

                }else if (blindnessId.equalsIgnoreCase("3")){
                    edt_injury_right.setText("Right Eye Blind");
                    edt_right_remark.setText("Right Eye Blind");
                    edt_left_remark.setText("Left Eye Blind");
                    edt_leftSnellen_remark.setText("Right Eye Blind");
                    edt_leftSnellen_remark.setText("Left Eye Blind");
                    edt_rightSnellen_remark.setText("Right Eye Blind");
                    edt_near_remark.setText("Both Eye Blind");
                    rb_glasses_no.setChecked(true);
                    edt_jaegar_chart_left.setEnabled(true);
                ...
                } else if (blindnessId.equalsIgnoreCase("4")) {
                    edt_injury_right.setText("");
                    edt_injury_right.setEnabled(true);
                    rigthDiseaseId = "";
                    edt_snellen_right.setText("");
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (type.equals("1")) {
                    ...
                    if (edt_snellen_right.getText().toString().trim().equals("6/6")
                            ||edt_snellen_right.getText().toString().trim().equals("6/9")
                            ||edt_snellen_right.getText().toString().trim().equals("6/12")
                            ||edt_snellen_right.getText().toString().trim().equals("6/18")
                            ||edt_snellen_right.getText().toString().trim().equals("6/24")
                            ||edt_snellen_right.getText().toString().trim().equals("6/36")) {
                        edt_right_remark.setText("Normal Vision");
                        edt_rightSnellen_remark.setText("Normal Vision");
                        edt_near_remark.setText("Normal Vision");

                    } else {
                        edt_right_remark.setText("To be referred to ophthalmologist");
                        edt_rightSnellen_remark.setText("To be referred to ophthalmologist");
                        edt_right_remark.setText("To be referred to ophthalmologist");
                    ...
                    if (edt_snellen_left.getText().toString().trim().equals("6/6")||edt_snellen_left.getText().toString().trim().equals("6/9")||edt_snellen_left.getText().toString().trim().equals("6/12")||edt_snellen_left.getText().toString().trim().equals("6/18")||edt_snellen_left.getText().toString().trim().equals("6/24")||edt_snellen_left.getText().toString().trim().equals("6/36")) {
                        edt_left_remark.setText("Normal Vision");
                        edt_leftSnellen_remark.setText("Normal Vision");
                        edt_near_remark.setText("Normal Vision");

                    } else {
                        edt_left_remark.setText("To be referred to ophthalmologist");
                        edt_leftSnellen_remark.setText("To be referred to ophthalmologist");
                        edt_near_remark.setText("To be referred to ophthalmologist");
    ...
    private void showJaegarChartListDialog(final ArrayList<MasterModel> pipeTypeList) {
        ...
        builderSingle.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                edt_jaegar_chart_right.setText(pipeTypeList.get(which).getName());



                if (edt_jaegar_chart_right.getText().toString().trim().equals("N10")
                        ||edt_jaegar_chart_right.getText().toString().trim().equals("N12")
                        ||edt_jaegar_chart_right.getText().toString().trim().equals("N18")) {
                    edt_right_remark.setText("To be referred to ophthalmologist");
                }else {

                    if (edt_jaegar_chart_right.getText().toString().trim().equals("N8")
                            ||edt_jaegar_chart_right.getText().toString().trim().equals("N6")
                            ||edt_jaegar_chart_right.getText().toString().trim().equals("N5")){
                        edt_right_remark.setText("Normal Vision");

                    }

//                    if (edt_snellen_right.getText().toString().equalsIgnoreCase("6/60")){
//                        edt_right_remark.setText("To be referred to ophthalmologist");
//
//                    }else {
//                        edt_right_remark.setText("Normal Vision");
...
//                }
    ...
    private void showJaegarChartListDialogLeft(final ArrayList<MasterModel> pipeTypeList) {
        final AlertDialog.Builder builderSingle = new AlertDialog.Builder(context);
        ...
        builderSingle.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                edt_jaegar_chart_left.setText(pipeTypeList.get(which).getName());


                if (edt_jaegar_chart_left.getText().toString().trim().equals("N10")||edt_jaegar_chart_left.getText().toString().trim().equals("N12")||edt_jaegar_chart_left.getText().toString().trim().equals("N18")) {
                    edt_left_remark.setText("To be referred to ophthalmologist");
                }else {
                    if (edt_jaegar_chart_left.getText().toString().trim().equals("N8")
                            ||edt_jaegar_chart_left.getText().toString().trim().equals("N6")
                    ||edt_jaegar_chart_left.getText().toString().trim().equals("N5")){
                        edt_left_remark.setText("Normal Vision");

                    }

//                    if (edt_snellen_left.getText().toString().equalsIgnoreCase("6/60")){
//                        edt_left_remark.setText("To be referred to ophthalmologist");
//
//                    }else {
//                        edt_left_remark.setText("Normal Vision");
...
//                }
    ...
    private void submitData() {
        ...
        if (edt_jaegar_chart_left.getText().toString().trim().isEmpty()) {
            edt_jaegar_chart_left.setError("Please select this field");
            edt_jaegar_chart_left.requestFocus();
            return;
        }


        if (edt_jaegar_chart_right.getText().toString().trim().isEmpty()) {
            edt_jaegar_chart_right.setError("Please select this field");
            edt_jaegar_chart_right.requestFocus();
            return;
        }
...
//        plateArray.add(plateObj24);
        ...
        if (Utilities.isNetworkAvailable(context)) {
            new InsertEyeScreeningDetails_New().execute(
                    ...
                    glassesId,
                    blindnessId,
                    edt_rightSnellen_remark.getText().toString().trim(),
                    edt_leftSnellen_remark.getText().toString().trim(),
                    edt_jaegar_chart_left.getText().toString().trim(),
                    versionName
            ...
            if (BuildConfig.isBeta){
                ...
                try {
                    ...
                    RequestBody formBody = new FormBody.Builder()
                            ...
                            .add("blindnessId", params[19])
                            .add("snellenrightremark", params[20])
                            .add("snellenleftremark", params[21])
                            .add("GagerChartReportleft", params[22])
                            .add("VersionNo", params[23])

                            .build();

                    OkHttpClient client = new OkHttpClient();

//                    String url = ApplicationConstants.webservice_d2d + ApplicationConstants.InsertEyeScreeningDetails_V1;
                String url = ApplicationConstants.webservice_d2d + ApplicationConstants.InsertEyeScreeningDetails_VersionNo;
    ...
    private class InsertEyeScreeningMachineData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (remidioModel != null) {
                    url = ApplicationConstants.webservice_d2d + ApplicationConstants.InsertVisionScreeningJSONByMachineDash;
                } else {
                    url = ApplicationConstants.webservice_d2d + ApplicationConstants.InsertVisionScreeningJSONByMachine;
                }
...
//        String visionJson = "{\"examID\":\"13080011\",\"patientAge\":20,\"result\":{\"L1\":{\"A\":\"103\",\"C\":\"-0.25\",\"S\":\"0.50\"},\"R1\":{\"A\":\"85\",\"C\":\"-1.00\",\"S\":\"1.00\"},\"L-Avg\":{\"A\":\"90\",\"C\":\"-0.25\",\"S\":\"0.75\"},\"R3\":{\"A\":\"81\",\"C\":\"-1.00\",\"S\":\"1.00\"},\"L2\":{\"A\":\"90\",\"C\":\"-0.25\",\"S\":\"0.75\"},\"R2\":{\"A\":\"78\",\"C\":\"-1.25\",\"S\":\"1.00\"},\"L3\":{\"A\":\"77\",\"C\":\"-0.25\",\"S\":\"0.75\"},\"R-Avg\":{\"A\":\"81\",\"C\":\"-1.00\",\"S\":\"1.00\"}}}";
        ...
        String TAG = HealthScreeningVisualTest_Activity.class.getSimpleName();

        Log.d("TAG", "setVisualDataToUI: " + visionJson);
        try {
            JSONObject jsonObject = new JSONObject(visionJson);
            JSONObject jsonObject1 = jsonObject.getJSONObject("result");
            Log.d(TAG, "setVisualDataToUI: " + jsonObject1.has("L-Avg"));
            if (jsonObject1.has("L-Avg")) {
                remidioModel = new Gson().fromJson(visionJson, RemidioModel.class);
            } else {
                remidioModel_v1 = new Gson().fromJson(visionJson, RemidioModel_V1.class);
            }
...
//        tvRescan.setVisibility(View.VISIBLE);
        ...
        if (remidioModel != null) {
            ...
            remidioModel_v1.setUserId(patientDetails.getRegdId());

            tvSRight.setText(remidioModel_v1.getResult().getRAvg().getS());
            tvSLeft.setText(remidioModel_v1.getResult().getLAvg().getS());

            tvCRight.setText(remidioModel_v1.getResult().getRAvg().getC());
            tvCLeft.setText(remidioModel_v1.getResult().getLAvg().getC());

            tvARight.setText(remidioModel_v1.getResult().getRAvg().getA());
            tvALeft.setText(remidioModel_v1.getResult().getLAvg().getA());
        }
    }
}
