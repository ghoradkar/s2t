...
public class ReturnPacketActivity extends AppCompatActivity {
...
//    private androidx.appcompat.widget.SearchView ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_return_packet);
    ...
    private void initView() {
        context = ReturnPacketActivity.this;
...
//        tv_to_date.setText(mdformat.format(calendar.getTime()));
    ...
    private void setUpToolbar() {
        ...
        getSupportActionBar().setTitle("Packet Allocation");
...
//                }
        ...
        btn_accept_courier.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog dialog;
                dialog = new Dialog(ReturnPacketActivity.this);
