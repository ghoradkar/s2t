...
class CampDetailsResponse {
  String? status;
  String? message;
  List<CampDetailOutput>? output;

  CampDetailsResponse({this.status, this.message, this.output});

  CampDetailsResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    if (json['output'] != null) {
      output = <CampDetailOutput>[];
      json['output'].forEach((v) {
        output!.add(CampDetailOutput.fromJson(v));
      });
    }
  }
...
class CampDetailOutput {
  ...
  CampDetailOutput.fromJson(Map<String, dynamic> json) {
