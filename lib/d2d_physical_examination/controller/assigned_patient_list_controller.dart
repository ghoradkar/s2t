...
import 'package:s2toperational/calling_modules/repository/beneficiary_card_repository.dart';
import 'package:s2toperational/d2d_physical_examination/model/attendances_list_using_site_details_id_response.dart';
import 'package:s2toperational/d2d_physical_examination/model/get_my_oprator_response.dart';
import 'package:s2toperational/d2d_physical_examination/model/insert_beneficiary_calling_log_response.dart';
import 'package:s2toperational/d2d_physical_examination/model/insert_details_response.dart';
import 'package:s2toperational/d2d_physical_examination/model/is_24_by7_is_account_created_response.dart';
import 'package:s2toperational/d2d_physical_examination/model/organisation_wise_api_key_response.dart';
import 'package:s2toperational/camp_calendar/model/sub_organization_response.dart';
import 'package:s2toperational/d2d_physical_examination/model/t2t_calling_api_details_response.dart';
...
class AssignedPatientListController extends GetxController
  ...
  void _onPatientList(
    ...
    for (final p in patientList) {
      debugPrint(
        '[PATIENT_LIST_REFRESH] regdId=${p.regdId} isCall=${p.isCall} '
        'doctorMapStatus=${p.doctorMapStatus}',
      );
    }
