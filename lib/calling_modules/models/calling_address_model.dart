class CallingAddressModel {
  String? status;
  String? message;
  List<CallingAddressOutput>? output;

  CallingAddressModel({this.status, this.message, this.output});

  CallingAddressModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    if (json['output'] != null) {
      output = <CallingAddressOutput>[];
      json['output'].forEach((v) {
        output!.add(CallingAddressOutput.fromJson(v));
      });
    }
  }
...
class CallingAddressOutput {
  ...
  CallingAddressOutput.fromJson(Map<String, dynamic> json) {
