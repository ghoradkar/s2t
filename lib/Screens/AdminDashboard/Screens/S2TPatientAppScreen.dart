...
class S2tPatientAppScreen extends StatefulWidget {
  ...
  @override
  State<S2tPatientAppScreen> createState() => S2tPatientAppScreenState();
}

class S2tPatientAppScreenState extends State<S2tPatientAppScreen> {
  final AdminController adminController = Get.put(AdminController());

  @override
  void initState() {
    adminController.checkInternetS2TApp();
    super.initState();
  }
