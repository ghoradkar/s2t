// export 'package:s2toperational/Modules/Json_Class/SubOrganizationResponse/SubOrganizationResponse.dart';


class SubOrganizationResponse {
  String? status;
  String? message;
  List<SubOrganizationOutput>? output;

  SubOrganizationResponse({this.status, this.message, this.output});

  SubOrganizationResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
