...
import 'package:s2toperational/Screens/daily_work_dashboard/controller/daily_work_dashboard_controller.dart';
import 'package:s2toperational/Screens/daily_work_dashboard/screen/rejected_beneficiary_list_screen.dart';
import 'package:s2toperational/Screens/daily_work_dashboard/screen/rejected_beneficiary_tracking_screen.dart';
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Image.asset(
                          ...
                          color: c.doorToDoorCamp ? kWhiteColor : kPrimaryColor,
                        ),
                      ),
                      const SizedBox(width: 6),
                      Text(
...
class _FilterCard extends StatelessWidget {
            ...
            children: [
              Expanded(
                child: AppTextField(
                  ...
                  controller: TextEditingController(text: c.fromDate),
                  readOnly: true,
                  label: RichText(
                    text: TextSpan(
                      text: 'From Date *',
              ...
              Expanded(
                child: AppTextField(
                  ...
                  controller: TextEditingController(text: c.toDate),
                  readOnly: true,
                  label: RichText(
                    text: TextSpan(
                      text: 'To Date *',
                  ...
                  child: AppTextField(
                    onTap: () {
                      if (c.selectedSubOrganization == null) {
                        ToastManager.toast("Please select sub organization");
                        return;
                      }
  ...
  Future<void> _showDivisionDropdown(BuildContext ctx) async {
    ...
    _showBottomSheet(ctx, "Division", list, DropDownTypeMenu.BindDivision, (
      selected,
    ) {
  ...
  Future<void> _showDistrictDropdown(BuildContext ctx) async {
    ...
    _showBottomSheet(ctx, "District", list, DropDownTypeMenu.BindDistrict, (
      selected,
    ) {
  ...
  Future<void> _showLabDropdown(BuildContext ctx) async {
    ...
    _showBottomSheet(ctx, "Lab", list, DropDownTypeMenu.BindLab, (selected) {
  ...
  void _onRejectedTap(BuildContext ctx) {
    if (c.isAdminDesignation) {
      Navigator.push(
        ...
        MaterialPageRoute(
          builder:
              (_) => RejectedBeneficiaryTrackingScreen(
                fromDate: c.fromDate,
                toDate: c.toDate,
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder:
              (_) => RejectedBeneficiaryListScreen(
                fromDate: c.fromDate,
                toDate: c.toDate,
                oganizationId: c.resolvedOrgId,
                divisionId: c.resolvedDivId,
