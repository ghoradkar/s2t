...
import 'package:s2toperational/Screens/daily_work_dashboard/controller/rejected_beneficiary_info_controller.dart';
import 'package:s2toperational/Screens/daily_work_dashboard/screen/rejected_beneficiary_team_view.dart';
import 'package:s2toperational/Modules/widgets/DropDownListScreen/DropDownListScreen.dart';
// import 'package:s2toperational/Views/RejectedBeneficiaryTeamView/rejected_beneficiary_team_view.dart';
...
import 'rejected_beneficiary_details_view.dart';
import 'rejection_details_view.dart';
                      ...
                      children: [
                        ...
                        if (c.showRemark) ...[
                          ...
                          AppTextField(
                            ...
                            controller: TextEditingController(
                              text: c.selectedRemark?.assignmentRemarks ?? "",
                            ),
                            label: RichText(
                              text: TextSpan(
                                text: 'Remark *',
                        ...
                        if (c.showAppoointmentDate) ...[
                          ...
                          AppTextField(
                            readOnly: true,
                            onTap: () => c.selectAppointmentDate(context),
                            controller: TextEditingController(
                              text: c.appoointmentDate,
                            ),
                            label: RichText(
                              text: TextSpan(
                      ...
                      if (c.showReRegisterButton)
                        SizedBox(
                          ...
                          child: AppActiveButton(
                            ...
                            isCancel: false,
                            onTap: () => c.onReRegisterTapped(context),
                          ),
                        ),
                    ],
                  ),
