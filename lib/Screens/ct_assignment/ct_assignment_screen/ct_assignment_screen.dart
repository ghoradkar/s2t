...
import 'package:s2toperational/Screens/ct_assignment/ct_assignment_screen/ct_assignment_row/ct_assignment_row_widget.dart';
...
import '../assign_team_for_ct_details/assign_team_for_ct_details_screen.dart';
import 'ct_assignment_filter_view/ct_assignment_filter_widget.dart';
...
class _CTAssignmentScreenState extends State<CTAssignmentScreen> {
  ...
  void initState() {
    ...
    DateTime fromDate = toDate.subtract(const Duration(days: 3));
                      ...
                      onSelectTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder:
                                (context) =>
                                    AssignTeamForCTDetailsScreen(selectedCT: obj),
                          ),
                        ).then((value) {
  ...
  void getPostCampDetails() {
    ...
    print("getPostCampDetails params: $param");
