...
class AssignTeamForCTDetailsScreen extends StatefulWidget {
  AssignTeamForCTDetailsScreen({super.key, required this.selectedCT});

  T2TCTBeneficiaryDetailsOutput selectedCT;

  @override
  State<AssignTeamForCTDetailsScreen> createState() => _AssignTeamForCTDetailsScreenState();
}

class _AssignTeamForCTDetailsScreenState extends State<AssignTeamForCTDetailsScreen> {
  ...
  void getDependentInfo() {
    ...
    Map<String, String> param = {
      "T2T_Order_Id": widget.selectedCT.t2tOrderId.toString(),
  ...
  void submitData() {
    ...
    if (isSelectedAssignD2DTeam) {
      if (selectedTeam == null) {
        ...
        jsonArray.add({
          "USERID": (selectedTeam?.memberUserID1 ?? 0).toString(),
          "Teamid": (selectedTeam?.teamID ?? 0).toString(),
        });

        jsonArray.add({
          "USERID": (selectedTeam?.memberUserID2 ?? 0).toString(),
          "Teamid": (selectedTeam?.teamID ?? 0).toString(),
        });
      }
    } else {
    ...
    Map<String, String> param = {
      ...
      "T2T_Order_Id": widget.selectedCT.t2tOrderId.toString(),
      "TreatmentID": widget.selectedCT.regdid.toString(),
    };
