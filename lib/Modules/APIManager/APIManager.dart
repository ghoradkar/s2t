...
import '../../Screens/d2d_physical_examination/model/attendances_list_using_site_details_id_response.dart';
import '../../Screens/d2d_physical_examination/model/beneficiary_list_by_reg_id_response.dart';
import '../../Screens/d2d_physical_examination/model/d2d_camp_mapped_doctor_list_response.dart';
import '../../Screens/d2d_physical_examination/model/d2d_physical_exam_details_response.dart';
import '../../Screens/d2d_physical_examination/model/get_my_oprator_response.dart';
import '../../Screens/d2d_physical_examination/model/insert_details_response.dart';
import '../../Screens/d2d_physical_examination/model/is_24_by7_is_account_created_response.dart';
import '../../Screens/d2d_physical_examination/model/t2t_calling_api_details_response.dart';
import '../../Screens/d2d_physical_examination/model/team_number_by_campId_and_user_id_list_response.dart';
...
import '../../Screens/acknowledgement/model/acknowledgement_patient_list_response.dart';
...
import '../../Screens/expense_claim/model/advadetails_new_version_v2_response.dart';
import '../../Screens/expense_claim/model/advances_request_details_show_response.dart';
import '../../Screens/d2d_physical_examination/model/all_district_list_for_phy_exam_response.dart';
...
import '../../Screens/device_and_resource_mapping/models/assign_resources_response.dart';
import '../../Screens/team_camp_mapping/model/assigned_external_resource_details_response.dart';
import '../../Screens/appointment_sample_collection_ct/models/assignment_remarks_response.dart';
import '../../Screens/ct_assignment/model/department_type_response.dart';

// import '../Json_Class/AttendancesListUsingSiteDetailsIDResponse/AttendancesListUsingSiteDetailsIDResponse.dart';
import '../../Screens/camp_details/model/audio_screening_details_response.dart';
import '../../Screens/appointments_confirmed_list/model/beneficiaries_details_response.dart';
import '../../Screens/appointments_confirmed_list/model/beneficiary_dependant_details_response.dart';
import '../../Screens/ct_assignment/model/beneficiary_details_for_assign_teamid_details_response.dart';
import '../../Screens/daily_work_dashboard/model/beneficiary_status_and_details_response.dart';
import '../../Screens/camp_details/model/beneficiary_worker_response.dart';
import '../../Screens/expense_claim/model/bill_submission_response.dart';
import '../../Screens/camp_calendar/model/bind_district_response.dart';
import '../../Screens/appointments_confirmed_list/model/call_status_list_response.dart';
import '../../Screens/health_screening_details/models/camp_close_camp_details_response.dart';
import '../../Screens/health_screening_details/models/camp_close_details_response.dart';
import '../../Screens/camp_calendar/model/camp_count_with_day_response.dart';
import '../../Screens/camp_details/model/camp_details_response.dart';
import '../../Screens/resource_re_mapping/models/CampDetailsntApprovalResponse.dart';
import '../../Screens/health_screening_details/models/camp_details_on_lab_for_door_to_door_response.dart';
import '../../Screens/camp_readiness_form/models/campId_list_response.dart';
import '../../Screens/camp_calendar/model/camp_list_v3_response.dart';
...
import '../../Screens/camp_calendar/model/camp_type_and_catagory_response.dart';
import '../../Screens/camp_creation/models/camp_type_response.dart';
import '../../Screens/expense_claim/model/camp_wise_invoice_details_response.dart';
import '../../Screens/camp_creation/models/company_list_response.dart';
import '../../Screens/ct_assignment/model/confirmatory_tests_screening_response.dart';
import '../../Screens/ct_assignment/model/confirmatory_tests_screening_tube_response.dart';
import '../../Screens/device_and_resource_mapping/models/consumable_list_details_response.dart';
import '../../Screens/device_and_resource_mapping/models/consumables_list_response.dart';
import '../../Screens/d2d_team/model/d2d_non_working_teams_response.dart';

// import '../Json_Class/D2DPhysicalExamDetailsResponse/d2d_physical_exam_details_response.dart';
import '../../Screens/d2d_physical_examination/model/d2d_physical_examnination_details_response.dart';
import '../../Screens/d2d_team/model/d2d_team_member_details_response.dart';
import '../../Screens/d2d_physical_examination/model/d2d_team_wise_phy_exam_details_response.dart';
import '../../Screens/d2d_team/model/d2d_teams_count_response.dart';
import '../../Screens/medicine_delivery_menu/model/data_for_packet_receive_response.dart';
import '../../Screens/device_and_resource_mapping/models/devices_list_response.dart';
import '../../Screens/camp_calendar/model/bind_division_response.dart';
import '../../Screens/expense_claim/model/expense_camp_id_list_v1_response.dart';
import '../../Screens/expense_claim/model/expense_head_response.dart';
...
import '../../Screens/d2d_physical_examination/model/insert_beneficiary_calling_log_response.dart';

// import '../Json_Class/Is24By7IsAccountCreatedResponse/is_24_by7_is_account_created_response.dart';
import '../../Screens/d2d_team/model/lab_by_user_id_response.dart';
import '../../Screens/daily_work_dashboard/model/lab_data_response.dart';
import '../../Screens/camp_creation/models/landing_lab_camp_creation_response.dart';
import '../../Screens/camp_details/model/lung_function_test_details_response.dart';
import '../../Screens/expense_claim/model/month_wise_invoice_response.dart';
import '../../Screens/camp_calendar/model/monthly_survey_site_response.dart';
import '../../Screens/d2d_physical_examination/model/organisation_wise_api_key_response.dart';
import '../../Screens/camp_details/model/other_reason_for_patient_rejection_response.dart';
import '../../Screens/medicine_delivery_menu/model/packet_accept_data_response.dart';
import '../../Screens/medicine_delivery_menu/model/packet_collection_response.dart';
import '../../Screens/medicine_delivery_menu/model/packet_return_response.dart';
import '../../Screens/camp_details/model/patient_checkup_analysis_report_response.dart';
import '../../Screens/medicine_delivery_menu/model/patient_list_re_allocation_for_medicine_delivery_response.dart';
import '../../Screens/camp_details/model/patient_status_details_list_response.dart';
import '../../Screens/daily_work_dashboard/model/recollection_assignment_remarks_response.dart';
import '../../Screens/daily_work_dashboard/model/recollection_beneficiary_dashboard_for_mob_response.dart';
import '../../Screens/daily_work_dashboard/model/recollection_beneficiary_status_and_details_count_v1_response.dart';
import '../../Screens/daily_work_dashboard/model/recollection_beneficiary_to_team_response.dart';
import '../../Screens/appointments_confirmed_list/model/remark_list_response.dart';
import '../../Screens/medicine_delivery_menu/model/report_delivery_executive_response.dart';
import '../../Screens/device_and_resource_mapping/models/resource_list_response.dart';
import '../../Screens/resource_re_mapping/models/ResourceReMappingCampResponse.dart';
import '../../Screens/appointments_confirmed_list/model/screened_dependent_count_response.dart';
import '../../Screens/camp_creation/models/screening_test_camp_creation_response.dart';
import '../../Screens/ct_assignment/model/selected_teams_data_list_response.dart';
import '../../Screens/device_and_resource_mapping/models/sub_devices_list_response.dart';
import '../../Screens/expense_claim/model/sub_expense_heads_response.dart';
import '../../Screens/camp_calendar/model/sub_organization_response.dart';
import '../../Screens/device_and_resource_mapping/models/sub_resource_list_response.dart';
import '../../Screens/device_and_resource_mapping/models/submit_device_mapping_response.dart';
import '../../Screens/ct_assignment/model/t2t_ct_beneficiary_details_response.dart';
import '../../Screens/ct_assignment/model/t2t_ct_team_and_beneficiary_response.dart';
import '../../Screens/ct_assignment/model/t2t_ct_user_details_response.dart';
...
import '../../Screens/team_camp_mapping/model/team_camp_lab_response.dart';
import '../../Screens/team_camp_mapping/model/team_details_list_for_assign_response.dart';
import '../../Screens/camp_details/model/team_details_list_response.dart';

// import '../Json_Class/TeamNumberByCampIdAndUserIdListResponse/team_number_by_campId_and_user_id_list_response.dart';
import '../../Screens/d2d_physical_examination/model/team_wise_physical_exam_details_response.dart';
...
import '../../Screens/camp_details/model/test_list_for_reject_response.dart';
...
import '../../Screens/verify_otp/models/user_android_id_response.dart';
import '../../Screens/user_attendance/model/user_attandance_response.dart';
import '../../Screens/user_attendance/model/user_attendances_using_site_details_id_response.dart';
import '../../Screens/user_attendance/model/user_camp_mapping_and_attendance_data_response.dart';
import '../../Screens/user_attendance/model/user_camp_mapping_and_attendance_status_response.dart';
import '../../Screens/resource_re_mapping/models/UserCampMappingStatusResponse.dart';
import '../../Screens/expense_claim/model/user_invoice_payment_details_response.dart';
import '../../Screens/medicine_delivery_menu/model/user_mapped_taluka_response.dart';
import '../../Screens/camp_details/model/vision_screening_details_response.dart';
...
class APIManager {
  ...
  Future<void> uploadSequentially(
    ...
    for (var file in files) {
      ...
      if (response.statusCode == 200) {
        print("âœ… Uploaded ${file.path}");
        successCount++;
      } else {
        print("âŒ Failed ${file.path}: ${response.statusCode}");
        failCount++;
      }
    }
