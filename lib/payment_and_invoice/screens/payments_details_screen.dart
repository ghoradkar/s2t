                ...
                : Container(
                  ...
                  child: Column(
                    children: [
                      _detailRow(
                        "Payable Amount",
                        FormatterManager.formatAmount(details?.payableAmount),
                      ),
                      _detailRow(
                        "Penalty",
                        FormatterManager.formatAmount(details?.penaltyAmount),
                      ),
                      _detailRow(
                        "TDS",
                        FormatterManager.formatAmount(details?.tDSAmount),
                      ),
                      controller.isDoctor
                          ? _detailRow(
                            "Gross Amount",
                            FormatterManager.formatAmount(
                              details?.grossAmount,
                            ),
                          )
                          : const SizedBox.shrink(),
